 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(q,Y){var Z=q.length;q.push(Y);e:for(;0<Z;){var ve=Z-1>>>1,Ne=q[ve];if(0<i(Ne,Y))q[ve]=Y,q[Z]=Ne,Z=ve;else break e}}function n(q){return q.length===0?null:q[0]}function r(q){if(q.length===0)return null;var Y=q[0],Z=q.pop();if(Z!==Y){q[0]=Z;e:for(var ve=0,Ne=q.length,Or=Ne>>>1;ve<Or;){var Vt=2*(ve+1)-1,Mr=q[Vt],$t=Vt+1,Bn=q[$t];if(0>i(Mr,Z))$t<Ne&&0>i(Bn,Mr)?(q[ve]=Bn,q[$t]=Z,ve=$t):(q[ve]=Mr,q[Vt]=Z,ve=Vt);else if($t<Ne&&0>i(Bn,Z))q[ve]=Bn,q[$t]=Z,ve=$t;else break e}}return Y}function i(q,Y){var Z=q.sortIndex-Y.sortIndex;return Z!==0?Z:q.id-Y.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var u=[],c=[],f=1,p=null,m=3,w=!1,R=!1,C=!1,O=typeof setTimeout=="function"?setTimeout:null,T=typeof clearTimeout=="function"?clearTimeout:null,v=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function A(q){for(var Y=n(c);Y!==null;){if(Y.callback===null)r(c);else if(Y.startTime<=q)r(c),Y.sortIndex=Y.expirationTime,e(u,Y);else break;Y=n(c)}}function V(q){if(C=!1,A(q),!R)if(n(u)!==null)R=!0,yn(M);else{var Y=n(c);Y!==null&&Xs(V,Y.startTime-q)}}function M(q,Y){R=!1,C&&(C=!1,T(y),y=-1),w=!0;var Z=m;try{for(A(Y),p=n(u);p!==null&&(!(p.expirationTime>Y)||q&&!P());){var ve=p.callback;if(typeof ve=="function"){p.callback=null,m=p.priorityLevel;var Ne=ve(p.expirationTime<=Y);Y=t.unstable_now(),typeof Ne=="function"?p.callback=Ne:p===n(u)&&r(u),A(Y)}else r(u);p=n(u)}if(p!==null)var Or=!0;else{var Vt=n(c);Vt!==null&&Xs(V,Vt.startTime-Y),Or=!1}return Or}finally{p=null,m=Z,w=!1}}var L=!1,_=null,y=-1,E=5,S=-1;function P(){return!(t.unstable_now()-S<E)}function x(){if(_!==null){var q=t.unstable_now();S=q;var Y=!0;try{Y=_(!0,q)}finally{Y?I():(L=!1,_=null)}}else L=!1}var I;if(typeof v=="function")I=function(){v(x)};else if(typeof MessageChannel<"u"){var se=new MessageChannel,Re=se.port2;se.port1.onmessage=x,I=function(){Re.postMessage(null)}}else I=function(){O(x,0)};function yn(q){_=q,L||(L=!0,I())}function Xs(q,Y){y=O(function(){q(t.unstable_now())},Y)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(q){q.callback=null},t.unstable_continueExecution=function(){R||w||(R=!0,yn(M))},t.unstable_forceFrameRate=function(q){0>q||125<q?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):E=0<q?Math.floor(1e3/q):5},t.unstable_getCurrentPriorityLevel=function(){return m},t.unstable_getFirstCallbackNode=function(){return n(u)},t.unstable_next=function(q){switch(m){case 1:case 2:case 3:var Y=3;break;default:Y=m}var Z=m;m=Y;try{return q()}finally{m=Z}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(q,Y){switch(q){case 1:case 2:case 3:case 4:case 5:break;default:q=3}var Z=m;m=q;try{return Y()}finally{m=Z}},t.unstable_scheduleCallback=function(q,Y,Z){var ve=t.unstable_now();switch(typeof Z=="object"&&Z!==null?(Z=Z.delay,Z=typeof Z=="number"&&0<Z?ve+Z:ve):Z=ve,q){case 1:var Ne=-1;break;case 2:Ne=250;break;case 5:Ne=1073741823;break;case 4:Ne=1e4;break;default:Ne=5e3}return Ne=Z+Ne,q={id:f++,callback:Y,priorityLevel:q,startTime:Z,expirationTime:Ne,sortIndex:-1},Z>ve?(q.sortIndex=Z,e(c,q),n(u)===null&&q===n(c)&&(C?(T(y),y=-1):C=!0,Xs(V,Z-ve))):(q.sortIndex=Ne,e(u,q),R||w||(R=!0,yn(M))),q},t.unstable_shouldYield=P,t.unstable_wrapCallback=function(q){var Y=m;return function(){var Z=m;m=Y;try{return q.apply(this,arguments)}finally{m=Z}}}})(Wv);Kv.exports=Wv;var n1=Kv.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class XP{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(JP(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function JP(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Jd="@firebase/app",jy="0.14.7";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function UR(t){As(new gi("platform-logger",e=>new XP(e),"PRIVATE")),As(new gi("heartbeat",e=>new OR(e),"PRIVATE")),vr(Jd,jy,t),vr(Jd,jy,"esm2020"),vr("fire-js","")}UR("");var BR="firebase",jR="12.8.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */vr(BR,jR,"app");function dI(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const zR=dI,fI=new ja("auth","Firebase",dI());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Uu=new Pp("@firebase/auth");function $R(t,...e){Uu.logLevel<=re.WARN&&Uu.warn(`Auth (${Hs}): ${t}`,...e)}function Xl(t,...e){Uu.logLevel<=re.ERROR&&Uu.error(`Auth (${Hs}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ZR(t,e){return Gs(t,"POST","/v1/accounts:delete",e)}async function Bu(t,e){return Gs(t,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jl(t,e,n){return`firebase:${t}:${e}:${n}`}class fs{constructor(e,n,r){this.persistence=e,this.auth=n,this.userKey=r;const{config:i,name:s}=this.auth;this.fullUserKey=Jl(this.userKey,i.apiKey,s),this.fullPersistenceKey=Jl("persistence",i.apiKey,s),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const n=await Bu(this.auth,{idToken:e}).catch(()=>{});return n?Yt._fromGetAccountInfoResponse(this.auth,n,e):null}return Yt._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,r="authUser"){if(!n.length)return new fs(Sn(Qy),e,r);const i=(await Promise.all(n.map(async c=>{if(await c._isAvailable())return c}))).filter(c=>c);let s=i[0]||Sn(Qy);const o=Jl(r,e.config.apiKey,e.name);let l=null;for(const c of n)try{const f=await c._get(o);if(f){let p;if(typeof f=="string"){const m=await Bu(e,{idToken:f}).catch(()=>{});if(!m)break;p=await Yt._fromGetAccountInfoResponse(e,m,f)}else p=Yt._fromJSON(e,f);c!==s&&(l=p),s=c;break}}catch{}const u=i.filter(c=>c._shouldAllowMigration);return!s._shouldAllowMigration||!u.length?new fs(s,e,r):(s=u[0],l&&await s._set(o,l.toJSON()),await Promise.all(n.map(async c=>{if(c!==s)try{await c._remove(o)}catch{}})),new fs(s,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yy(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(II(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(vI(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(SI(e))return"Blackberry";if(AI(e))return"Webos";if(wI(e))return"Safari";if((e.includes("chrome/")||EI(e))&&!e.includes("edge/"))return"Chrome";if(TI(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=t.match(n);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function vI(t=je()){return/firefox\//i.test(t)}function wI(t=je()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function EI(t=je()){return/crios\//i.test(t)}function II(t=je()){return/iemobile/i.test(t)}function TI(t=je()){return/android/i.test(t)}function SI(t=je()){return/blackberry/i.test(t)}function AI(t=je()){return/webos/i.test(t)}function bp(t=je()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function aC(t=je()){var e;return bp(t)&&!!((e=window.navigator)!=null&&e.standalone)}function lC(){return TP()&&document.documentMode===10}function PI(t=je()){return bp(t)||TI(t)||AI(t)||SI(t)||/windows phone/i.test(t)||II(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function RI(t,e=[]){let n;switch(t){case"Browser":n=Yy(je());break;case"Worker":n=`${Yy(je())}-${t}`;break;default:n=t}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Hs}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var $I,Vo,qI,tu,sf,HI,GI,KI;(function(){var t,e=Object.defineProperty;function n(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof Nl=="object"&&Nl];for(var h=0;h<a.length;++h){var d=a[h];if(d&&d.Math==Math)return d}throw Error("Cannot find global object")}var r=n(this);function i(a,h){if(h)e:{var d=r;a=a.split(".");for(var g=0;g<a.length-1;g++){var N=a[g];if(!(N in d))break e;d=d[N]}a=a[a.length-1],g=d[a],h=h(g),h!=g&&h!=null&&e(d,a,{configurable:!0,writable:!0,value:h})}}i("Symbol.dispose",function(a){return a||Symbol("Symbol.dispose")}),i("Array.prototype.values",function(a){return a||function(){return this[Symbol.iterator]()}}),i("Object.entries",function(a){return a||function(h){var d=[],g;for(g in h)Object.prototype.hasOwnProperty.call(h,g)&&d.push([g,h[g]]);return d}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var s=s||{},o=this||self;function l(a){var h=typeof a;return h=="object"&&a!=null||h=="function"}function u(a,h,d){return a.call.apply(a.bind,arguments)}function c(a,h,d){return c=u,c.apply(null,arguments)}function f(a,h){var d=Array.prototype.slice.call(arguments,1);return function(){var g=d.slice();return g.push.apply(g,arguments),a.apply(this,g)}}function p(a,h){function d(){}d.prototype=h.prototype,a.Z=h.prototype,a.prototype=new d,a.prototype.constructor=a,a.Ob=function(g,N,D){for(var j=Array(arguments.length-2),ee=2;ee<arguments.length;ee++)j[ee-2]=arguments[ee];return h.prototype[N].apply(g,j)}}var m=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?a=>a&&AsyncContext.Snapshot.wrap(a):a=>a;function w(a){const h=a.length;if(h>0){const d=Array(h);for(let g=0;g<h;g++)d[g]=a[g];return d}return[]}function R(a,h){for(let g=1;g<arguments.length;g++){const N=arguments[g];var d=typeof N;if(d=d!="object"?d:N?Array.isArray(N)?"array":d:"null",d=="array"||d=="object"&&typeof N.length=="number"){d=a.length||0;const D=N.length||0;a.length=d+D;for(let j=0;j<D;j++)a[d+j]=N[j]}else a.push(N)}}class C{constructor(h,d){this.i=h,this.j=d,this.h=0,this.g=null}get(){let h;return this.h>0?(this.h--,h=this.g,this.g=h.next,h.next=null):h=this.i(),h}}function O(a){o.setTimeout(()=>{throw a},0)}function T(){var a=_;let h=null;return a.g&&(h=a.g,a.g=a.g.next,a.g||(a.h=null),h.next=null),h}class v{constructor(){this.h=this.g=null}add(h,d){const g=A.get();g.set(h,d),this.h?this.h.next=g:this.g=g,this.h=g}}var A=new C(()=>new V,a=>a.reset());class V{constructor(){this.next=this.g=this.h=null}set(h,d){this.h=h,this.g=d,this.next=null}reset(){this.next=this.g=this.h=null}}let M,L=!1,_=new v,y=()=>{const a=Promise.resolve(void 0);M=()=>{a.then(E)}};function E(){for(var a;a=T();){try{a.h.call(a.g)}catch(d){O(d)}var h=A;h.j(a),h.h<100&&(h.h++,a.next=h.g,h.g=a)}L=!1}function S(){this.u=this.u,this.C=this.C}S.prototype.u=!1,S.prototype.dispose=function(){this.u||(this.u=!0,this.N())},S.prototype[Symbol.dispose]=function(){this.dispose()},S.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function P(a,h){this.type=a,this.g=this.target=h,this.defaultPrevented=!1}P.prototype.h=function(){this.defaultPrevented=!0};var x=function(){if(!o.addEventListener||!Object.defineProperty)return!1;var a=!1,h=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const d=()=>{};o.addEventListener("test",d,h),o.removeEventListener("test",d,h)}catch{}return a}();function I(a){return/^[\s\xa0]*$/.test(a)}function se(a,h){P.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a&&this.init(a,h)}p(se,P),se.prototype.init=function(a,h){const d=this.type=a.type,g=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;this.target=a.target||a.srcElement,this.g=h,h=a.relatedTarget,h||(d=="mouseover"?h=a.fromElement:d=="mouseout"&&(h=a.toElement)),this.relatedTarget=h,g?(this.clientX=g.clientX!==void 0?g.clientX:g.pageX,this.clientY=g.clientY!==void 0?g.clientY:g.pageY,this.screenX=g.screenX||0,this.screenY=g.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=a.pointerType,this.state=a.state,this.i=a,a.defaultPrevented&&se.Z.h.call(this)},se.prototype.h=function(){se.Z.h.call(this);const a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var Re="closure_listenable_"+(Math.random()*1e6|0),yn=0;function Xs(a,h,d,g,N){this.listener=a,this.proxy=null,this.src=h,this.type=d,this.capture=!!g,this.ha=N,this.key=++yn,this.da=this.fa=!1}function q(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function Y(a,h,d){for(const g in a)h.call(d,a[g],g,a)}function Z(a,h){for(const d in a)h.call(void 0,a[d],d,a)}function ve(a){const h={};for(const d in a)h[d]=a[d];return h}const Ne="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Or(a,h){let d,g;for(let N=1;N<arguments.length;N++){g=arguments[N];for(d in g)a[d]=g[d];for(let D=0;D<Ne.length;D++)d=Ne[D],Object.prototype.hasOwnProperty.call(g,d)&&(a[d]=g[d])}}function Vt(a){this.src=a,this.g={},this.h=0}Vt.prototype.add=function(a,h,d,g,N){const D=a.toString();a=this.g[D],a||(a=this.g[D]=[],this.h++);const j=$t(a,h,g,N);return j>-1?(h=a[j],d||(h.fa=!1)):(h=new Xs(h,this.src,D,!!g,N),h.fa=d,a.push(h)),h};function Mr(a,h){const d=h.type;if(d in a.g){var g=a.g[d],N=Array.prototype.indexOf.call(g,h,void 0),D;(D=N>=0)&&Array.prototype.splice.call(g,N,1),D&&(q(h),a.g[d].length==0&&(delete a.g[d],a.h--))}}function $t(a,h,d,g){for(let N=0;N<a.length;++N){const D=a[N];if(!D.da&&D.listener==h&&D.capture==!!d&&D.ha==g)return N}return-1}var Bn="closure_lm_"+(Math.random()*1e6|0),Yc={};function Cm(a,h,d,g,N){if(Array.isArray(h)){for(let D=0;D<h.length;D++)Cm(a,h[D],d,g,N);return null}return d=Nm(d),a&&a[Re]?a.J(h,d,l(g)?!!g.capture:!1,N):iS(a,h,d,!1,g,N)}function iS(a,h,d,g,N,D){if(!h)throw Error("Invalid event type");const j=l(N)?!!N.capture:!!N;let ee=Jc(a);if(ee||(a[Bn]=ee=new Vt(a)),d=ee.add(h,d,g,j,D),d.proxy)return d;if(g=sS(),d.proxy=g,g.src=a,g.listener=d,a.addEventListener)x||(N=j),N===void 0&&(N=!1),a.addEventListener(h.toString(),g,N);else if(a.attachEvent)a.attachEvent(xm(h.toString()),g);else if(a.addListener&&a.removeListener)a.addListener(g);else throw Error("addEventListener and attachEvent are unavailable.");return d}function sS(){function a(d){return h.call(a.src,a.listener,d)}const h=oS;return a}function km(a,h,d,g,N){if(Array.isArray(h))for(var D=0;D<h.length;D++)km(a,h[D],d,g,N);else g=l(g)?!!g.capture:!!g,d=Nm(d),a&&a[Re]?(a=a.i,D=String(h).toString(),D in a.g&&(h=a.g[D],d=$t(h,d,g,N),d>-1&&(q(h[d]),Array.prototype.splice.call(h,d,1),h.length==0&&(delete a.g[D],a.h--)))):a&&(a=Jc(a))&&(h=a.g[h.toString()],a=-1,h&&(a=$t(h,d,g,N)),(d=a>-1?h[a]:null)&&Xc(d))}function Xc(a){if(typeof a!="number"&&a&&!a.da){var h=a.src;if(h&&h[Re])Mr(h.i,a);else{var d=a.type,g=a.proxy;h.removeEventListener?h.removeEventListener(d,g,a.capture):h.detachEvent?h.detachEvent(xm(d),g):h.addListener&&h.removeListener&&h.removeListener(g),(d=Jc(h))?(Mr(d,a),d.h==0&&(d.src=null,h[Bn]=null)):q(a)}}}function xm(a){return a in Yc?Yc[a]:Yc[a]="on"+a}function oS(a,h){if(a.da)a=!0;else{h=new se(h,this);const d=a.listener,g=a.ha||a.src;a.fa&&Xc(a),a=d.call(g,h)}return a}function Jc(a){return a=a[Bn],a instanceof Vt?a:null}var Zc="__closure_events_fn_"+(Math.random()*1e9>>>0);function Nm(a){return typeof a=="function"?a:(a[Zc]||(a[Zc]=function(h){return a.handleEvent(h)}),a[Zc])}function Ze(){S.call(this),this.i=new Vt(this),this.M=this,this.G=null}p(Ze,S),Ze.prototype[Re]=!0,Ze.prototype.removeEventListener=function(a,h,d,g){km(this,a,h,d,g)};function lt(a,h){var d,g=a.G;if(g)for(d=[];g;g=g.G)d.push(g);if(a=a.M,g=h.type||h,typeof h=="string")h=new P(h,a);else if(h instanceof P)h.target=h.target||a;else{var N=h;h=new P(g,a),Or(h,N)}N=!0;let D,j;if(d)for(j=d.length-1;j>=0;j--)D=h.g=d[j],N=tl(D,g,!0,h)&&N;if(D=h.g=a,N=tl(D,g,!0,h)&&N,N=tl(D,g,!1,h)&&N,d)for(j=0;j<d.length;j++)D=h.g=d[j],N=tl(D,g,!1,h)&&N}Ze.prototype.N=function(){if(Ze.Z.N.call(this),this.i){var a=this.i;for(const h in a.g){const d=a.g[h];for(let g=0;g<d.length;g++)q(d[g]);delete a.g[h],a.h--}}this.G=null},Ze.prototype.J=function(a,h,d,g){return this.i.add(String(a),h,!1,d,g)},Ze.prototype.K=function(a,h,d,g){return this.i.add(String(a),h,!0,d,g)};function tl(a,h,d,g){if(h=a.i.g[String(h)],!h)return!0;h=h.concat();let N=!0;for(let D=0;D<h.length;++D){const j=h[D];if(j&&!j.da&&j.capture==d){const ee=j.listener,Fe=j.ha||j.src;j.fa&&Mr(a.i,j),N=ee.call(Fe,g)!==!1&&N}}return N&&!g.defaultPrevented}function aS(a,h){if(typeof a!="function")if(a&&typeof a.handleEvent=="function")a=c(a.handleEvent,a);else throw Error("Invalid listener argument");return Number(h)>2147483647?-1:o.setTimeout(a,h||0)}function Dm(a){a.g=aS(()=>{a.g=null,a.i&&(a.i=!1,Dm(a))},a.l);const h=a.h;a.h=null,a.m.apply(null,h)}class lS extends S{constructor(h,d){super(),this.m=h,this.l=d,this.h=null,this.i=!1,this.g=null}j(h){this.h=arguments,this.g?this.i=!0:Dm(this)}N(){super.N(),this.g&&(o.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Js(a){S.call(this),this.h=a,this.g={}}p(Js,S);var Vm=[];function bm(a){Y(a.g,function(h,d){this.g.hasOwnProperty(d)&&Xc(h)},a),a.g={}}Js.prototype.N=function(){Js.Z.N.call(this),bm(this)},Js.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var eh=o.JSON.stringify,uS=o.JSON.parse,cS=class{stringify(a){return o.JSON.stringify(a,void 0)}parse(a){return o.JSON.parse(a,void 0)}};function Om(){}function Mm(){}var Zs={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function th(){P.call(this,"d")}p(th,P);function nh(){P.call(this,"c")}p(nh,P);var Lr={},Lm=null;function nl(){return Lm=Lm||new Ze}Lr.Ia="serverreachability";function Fm(a){P.call(this,Lr.Ia,a)}p(Fm,P);function eo(a){const h=nl();lt(h,new Fm(h))}Lr.STAT_EVENT="statevent";function Um(a,h){P.call(this,Lr.STAT_EVENT,a),this.stat=h}p(Um,P);function ut(a){const h=nl();lt(h,new Um(h,a))}Lr.Ja="timingevent";function Bm(a,h){P.call(this,Lr.Ja,a),this.size=h}p(Bm,P);function to(a,h){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return o.setTimeout(function(){a()},h)}function no(){this.g=!0}no.prototype.ua=function(){this.g=!1};function hS(a,h,d,g,N,D){a.info(function(){if(a.g)if(D){var j="",ee=D.split("&");for(let pe=0;pe<ee.length;pe++){var Fe=ee[pe].split("=");if(Fe.length>1){const $e=Fe[0];Fe=Fe[1];const rn=$e.split("_");j=rn.length>=2&&rn[1]=="type"?j+($e+"="+Fe+"&"):j+($e+"=redacted&")}}}else j=null;else j=D;return"XMLHTTP REQ ("+g+") [attempt "+N+"]: "+h+`
`+d+`
`+j})}function dS(a,h,d,g,N,D,j){a.info(function(){return"XMLHTTP RESP ("+g+") [ attempt "+N+"]: "+h+`
`+d+`
`+D+" "+j})}function Vi(a,h,d,g){a.info(function(){return"XMLHTTP TEXT ("+h+"): "+pS(a,d)+(g?" "+g:"")})}function fS(a,h){a.info(function(){return"TIMEOUT: "+h})}no.prototype.info=function(){};function pS(a,h){if(!a.g)return h;if(!h)return null;try{const D=JSON.parse(h);if(D){for(a=0;a<D.length;a++)if(Array.isArray(D[a])){var d=D[a];if(!(d.length<2)){var g=d[1];if(Array.isArray(g)&&!(g.length<1)){var N=g[0];if(N!="noop"&&N!="stop"&&N!="close")for(let j=1;j<g.length;j++)g[j]=""}}}}return eh(D)}catch{return h}}var rl={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},jm={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},zm;function rh(){}p(rh,Om),rh.prototype.g=function(){return new XMLHttpRequest},zm=new rh;function ro(a){return encodeURIComponent(String(a))}function mS(a){var h=1;a=a.split(":");const d=[];for(;h>0&&a.length;)d.push(a.shift()),h--;return a.length&&d.push(a.join(":")),d}function jn(a,h,d,g){this.j=a,this.i=h,this.l=d,this.S=g||1,this.V=new Js(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new $m}function $m(){this.i=null,this.g="",this.h=!1}var qm={},ih={};function sh(a,h,d){a.M=1,a.A=sl(nn(h)),a.u=d,a.R=!0,Hm(a,null)}function Hm(a,h){a.F=Date.now(),il(a),a.B=nn(a.A);var d=a.B,g=a.S;Array.isArray(g)||(g=[String(g)]),ig(d.i,"t",g),a.C=0,d=a.j.L,a.h=new $m,a.g=Ig(a.j,d?h:null,!a.u),a.P>0&&(a.O=new lS(c(a.Y,a,a.g),a.P)),h=a.V,d=a.g,g=a.ba;var N="readystatechange";Array.isArray(N)||(N&&(Vm[0]=N.toString()),N=Vm);for(let D=0;D<N.length;D++){const j=Cm(d,N[D],g||h.handleEvent,!1,h.h||h);if(!j)break;h.g[j.key]=j}h=a.J?ve(a.J):{},a.u?(a.v||(a.v="POST"),h["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.B,a.v,a.u,h)):(a.v="GET",a.g.ea(a.B,a.v,null,h)),eo(),hS(a.i,a.v,a.B,a.l,a.S,a.u)}jn.prototype.ba=function(a){a=a.target;const h=this.O;h&&qn(a)==3?h.j():this.Y(a)},jn.prototype.Y=function(a){try{if(a==this.g)e:{const ee=qn(this.g),Fe=this.g.ya(),pe=this.g.ca();if(!(ee<3)&&(ee!=3||this.g&&(this.h.h||this.g.la()||hg(this.g)))){this.K||ee!=4||Fe==7||(Fe==8||pe<=0?eo(3):eo(2)),oh(this);var h=this.g.ca();this.X=h;var d=gS(this);if(this.o=h==200,dS(this.i,this.v,this.B,this.l,this.S,ee,h),this.o){if(this.U&&!this.L){t:{if(this.g){var g,N=this.g;if((g=N.g?N.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!I(g)){var D=g;break t}}D=null}if(a=D)Vi(this.i,this.l,a,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,ah(this,a);else{this.o=!1,this.m=3,ut(12),Fr(this),io(this);break e}}if(this.R){a=!0;let $e;for(;!this.K&&this.C<d.length;)if($e=yS(this,d),$e==ih){ee==4&&(this.m=4,ut(14),a=!1),Vi(this.i,this.l,null,"[Incomplete Response]");break}else if($e==qm){this.m=4,ut(15),Vi(this.i,this.l,d,"[Invalid Chunk]"),a=!1;break}else Vi(this.i,this.l,$e,null),ah(this,$e);if(Gm(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),ee!=4||d.length!=0||this.h.h||(this.m=1,ut(16),a=!1),this.o=this.o&&a,!a)Vi(this.i,this.l,d,"[Invalid Chunked Response]"),Fr(this),io(this);else if(d.length>0&&!this.W){this.W=!0;var j=this.j;j.g==this&&j.aa&&!j.P&&(j.j.info("Great, no buffering proxy detected. Bytes received: "+d.length),mh(j),j.P=!0,ut(11))}}else Vi(this.i,this.l,d,null),ah(this,d);ee==4&&Fr(this),this.o&&!this.K&&(ee==4?_g(this.j,this):(this.o=!1,il(this)))}else NS(this.g),h==400&&d.indexOf("Unknown SID")>0?(this.m=3,ut(12)):(this.m=0,ut(13)),Fr(this),io(this)}}}catch{}finally{}};function gS(a){if(!Gm(a))return a.g.la();const h=hg(a.g);if(h==="")return"";let d="";const g=h.length,N=qn(a.g)==4;if(!a.h.i){if(typeof TextDecoder>"u")return Fr(a),io(a),"";a.h.i=new o.TextDecoder}for(let D=0;D<g;D++)a.h.h=!0,d+=a.h.i.decode(h[D],{stream:!(N&&D==g-1)});return h.length=0,a.h.g+=d,a.C=0,a.h.g}function Gm(a){return a.g?a.v=="GET"&&a.M!=2&&a.j.Aa:!1}function yS(a,h){var d=a.C,g=h.indexOf(`
`,d);return g==-1?ih:(d=Number(h.substring(d,g)),isNaN(d)?qm:(g+=1,g+d>h.length?ih:(h=h.slice(g,g+d),a.C=g+d,h)))}jn.prototype.cancel=function(){this.K=!0,Fr(this)};function il(a){a.T=Date.now()+a.H,Km(a,a.H)}function Km(a,h){if(a.D!=null)throw Error("WatchDog timer not null");a.D=to(c(a.aa,a),h)}function oh(a){a.D&&(o.clearTimeout(a.D),a.D=null)}jn.prototype.aa=function(){this.D=null;const a=Date.now();a-this.T>=0?(fS(this.i,this.B),this.M!=2&&(eo(),ut(17)),Fr(this),this.m=2,io(this)):Km(this,this.T-a)};function io(a){a.j.I==0||a.K||_g(a.j,a)}function Fr(a){oh(a);var h=a.O;h&&typeof h.dispose=="function"&&h.dispose(),a.O=null,bm(a.V),a.g&&(h=a.g,a.g=null,h.abort(),h.dispose())}function ah(a,h){try{var d=a.j;if(d.I!=0&&(d.g==a||lh(d.h,a))){if(!a.L&&lh(d.h,a)&&d.I==3){try{var g=d.Ba.g.parse(h)}catch{g=null}if(Array.isArray(g)&&g.length==3){var N=g;if(N[0]==0){e:if(!d.v){if(d.g)if(d.g.F+3e3<a.F)cl(d),ll(d);else break e;ph(d),ut(18)}}else d.xa=N[1],0<d.xa-d.K&&N[2]<37500&&d.F&&d.A==0&&!d.C&&(d.C=to(c(d.Va,d),6e3));Ym(d.h)<=1&&d.ta&&(d.ta=void 0)}else Br(d,11)}else if((a.L||d.g==a)&&cl(d),!I(h))for(N=d.Ba.g.parse(h),h=0;h<N.length;h++){let pe=N[h];const $e=pe[0];if(!($e<=d.K))if(d.K=$e,pe=pe[1],d.I==2)if(pe[0]=="c"){d.M=pe[1],d.ba=pe[2];const rn=pe[3];rn!=null&&(d.ka=rn,d.j.info("VER="+d.ka));const jr=pe[4];jr!=null&&(d.za=jr,d.j.info("SVER="+d.za));const Hn=pe[5];Hn!=null&&typeof Hn=="number"&&Hn>0&&(g=1.5*Hn,d.O=g,d.j.info("backChannelRequestTimeoutMs_="+g)),g=d;const Gn=a.g;if(Gn){const dl=Gn.g?Gn.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(dl){var D=g.h;D.g||dl.indexOf("spdy")==-1&&dl.indexOf("quic")==-1&&dl.indexOf("h2")==-1||(D.j=D.l,D.g=new Set,D.h&&(uh(D,D.h),D.h=null))}if(g.G){const gh=Gn.g?Gn.g.getResponseHeader("X-HTTP-Session-Id"):null;gh&&(g.wa=gh,ge(g.J,g.G,gh))}}d.I=3,d.l&&d.l.ra(),d.aa&&(d.T=Date.now()-a.F,d.j.info("Handshake RTT: "+d.T+"ms")),g=d;var j=a;if(g.na=Eg(g,g.L?g.ba:null,g.W),j.L){Xm(g.h,j);var ee=j,Fe=g.O;Fe&&(ee.H=Fe),ee.D&&(oh(ee),il(ee)),g.g=j}else gg(g);d.i.length>0&&ul(d)}else pe[0]!="stop"&&pe[0]!="close"||Br(d,7);else d.I==3&&(pe[0]=="stop"||pe[0]=="close"?pe[0]=="stop"?Br(d,7):fh(d):pe[0]!="noop"&&d.l&&d.l.qa(pe),d.A=0)}}eo(4)}catch{}}var _S=class{constructor(a,h){this.g=a,this.map=h}};function Wm(a){this.l=a||10,o.PerformanceNavigationTiming?(a=o.performance.getEntriesByType("navigation"),a=a.length>0&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(o.chrome&&o.chrome.loadTimes&&o.chrome.loadTimes()&&o.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function Qm(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function Ym(a){return a.h?1:a.g?a.g.size:0}function lh(a,h){return a.h?a.h==h:a.g?a.g.has(h):!1}function uh(a,h){a.g?a.g.add(h):a.h=h}function Xm(a,h){a.h&&a.h==h?a.h=null:a.g&&a.g.has(h)&&a.g.delete(h)}Wm.prototype.cancel=function(){if(this.i=Jm(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function Jm(a){if(a.h!=null)return a.i.concat(a.h.G);if(a.g!=null&&a.g.size!==0){let h=a.i;for(const d of a.g.values())h=h.concat(d.G);return h}return w(a.i)}var Zm=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function vS(a,h){if(a){a=a.split("&");for(let d=0;d<a.length;d++){const g=a[d].indexOf("=");let N,D=null;g>=0?(N=a[d].substring(0,g),D=a[d].substring(g+1)):N=a[d],h(N,D?decodeURIComponent(D.replace(/\+/g," ")):"")}}}function zn(a){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let h;a instanceof zn?(this.l=a.l,so(this,a.j),this.o=a.o,this.g=a.g,oo(this,a.u),this.h=a.h,ch(this,sg(a.i)),this.m=a.m):a&&(h=String(a).match(Zm))?(this.l=!1,so(this,h[1]||"",!0),this.o=ao(h[2]||""),this.g=ao(h[3]||"",!0),oo(this,h[4]),this.h=ao(h[5]||"",!0),ch(this,h[6]||"",!0),this.m=ao(h[7]||"")):(this.l=!1,this.i=new uo(null,this.l))}zn.prototype.toString=function(){const a=[];var h=this.j;h&&a.push(lo(h,eg,!0),":");var d=this.g;return(d||h=="file")&&(a.push("//"),(h=this.o)&&a.push(lo(h,eg,!0),"@"),a.push(ro(d).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),d=this.u,d!=null&&a.push(":",String(d))),(d=this.h)&&(this.g&&d.charAt(0)!="/"&&a.push("/"),a.push(lo(d,d.charAt(0)=="/"?IS:ES,!0))),(d=this.i.toString())&&a.push("?",d),(d=this.m)&&a.push("#",lo(d,SS)),a.join("")},zn.prototype.resolve=function(a){const h=nn(this);let d=!!a.j;d?so(h,a.j):d=!!a.o,d?h.o=a.o:d=!!a.g,d?h.g=a.g:d=a.u!=null;var g=a.h;if(d)oo(h,a.u);else if(d=!!a.h){if(g.charAt(0)!="/")if(this.g&&!this.h)g="/"+g;else{var N=h.h.lastIndexOf("/");N!=-1&&(g=h.h.slice(0,N+1)+g)}if(N=g,N==".."||N==".")g="";else if(N.indexOf("./")!=-1||N.indexOf("/.")!=-1){g=N.lastIndexOf("/",0)==0,N=N.split("/");const D=[];for(let j=0;j<N.length;){const ee=N[j++];ee=="."?g&&j==N.length&&D.push(""):ee==".."?((D.length>1||D.length==1&&D[0]!="")&&D.pop(),g&&j==N.length&&D.push("")):(D.push(ee),g=!0)}g=D.join("/")}else g=N}return d?h.h=g:d=a.i.toString()!=="",d?ch(h,sg(a.i)):d=!!a.m,d&&(h.m=a.m),h};function nn(a){return new zn(a)}function so(a,h,d){a.j=d?ao(h,!0):h,a.j&&(a.j=a.j.replace(/:$/,""))}function oo(a,h){if(h){if(h=Number(h),isNaN(h)||h<0)throw Error("Bad port number "+h);a.u=h}else a.u=null}function ch(a,h,d){h instanceof uo?(a.i=h,AS(a.i,a.l)):(d||(h=lo(h,TS)),a.i=new uo(h,a.l))}function ge(a,h,d){a.i.set(h,d)}function sl(a){return ge(a,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),a}function ao(a,h){return a?h?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function lo(a,h,d){return typeof a=="string"?(a=encodeURI(a).replace(h,wS),d&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function wS(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var eg=/[#\/\?@]/g,ES=/[#\?:]/g,IS=/[#\?]/g,TS=/[#\?@]/g,SS=/#/g;function uo(a,h){this.h=this.g=null,this.i=a||null,this.j=!!h}function Ur(a){a.g||(a.g=new Map,a.h=0,a.i&&vS(a.i,function(h,d){a.add(decodeURIComponent(h.replace(/\+/g," ")),d)}))}t=uo.prototype,t.add=function(a,h){Ur(this),this.i=null,a=bi(this,a);let d=this.g.get(a);return d||this.g.set(a,d=[]),d.push(h),this.h+=1,this};function tg(a,h){Ur(a),h=bi(a,h),a.g.has(h)&&(a.i=null,a.h-=a.g.get(h).length,a.g.delete(h))}function ng(a,h){return Ur(a),h=bi(a,h),a.g.has(h)}t.forEach=function(a,h){Ur(this),this.g.forEach(function(d,g){d.forEach(function(N){a.call(h,N,g,this)},this)},this)};function rg(a,h){Ur(a);let d=[];if(typeof h=="string")ng(a,h)&&(d=d.concat(a.g.get(bi(a,h))));else for(a=Array.from(a.g.values()),h=0;h<a.length;h++)d=d.concat(a[h]);return d}t.set=function(a,h){return Ur(this),this.i=null,a=bi(this,a),ng(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[h]),this.h+=1,this},t.get=function(a,h){return a?(a=rg(this,a),a.length>0?String(a[0]):h):h};function ig(a,h,d){tg(a,h),d.length>0&&(a.i=null,a.g.set(bi(a,h),w(d)),a.h+=d.length)}t.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],h=Array.from(this.g.keys());for(let g=0;g<h.length;g++){var d=h[g];const N=ro(d);d=rg(this,d);for(let D=0;D<d.length;D++){let j=N;d[D]!==""&&(j+="="+ro(d[D])),a.push(j)}}return this.i=a.join("&")};function sg(a){const h=new uo;return h.i=a.i,a.g&&(h.g=new Map(a.g),h.h=a.h),h}function bi(a,h){return h=String(h),a.j&&(h=h.toLowerCase()),h}function AS(a,h){h&&!a.j&&(Ur(a),a.i=null,a.g.forEach(function(d,g){const N=g.toLowerCase();g!=N&&(tg(this,g),ig(this,N,d))},a)),a.j=h}function PS(a,h){const d=new no;if(o.Image){const g=new Image;g.onload=f($n,d,"TestLoadImage: loaded",!0,h,g),g.onerror=f($n,d,"TestLoadImage: error",!1,h,g),g.onabort=f($n,d,"TestLoadImage: abort",!1,h,g),g.ontimeout=f($n,d,"TestLoadImage: timeout",!1,h,g),o.setTimeout(function(){g.ontimeout&&g.ontimeout()},1e4),g.src=a}else h(!1)}function RS(a,h){const d=new no,g=new AbortController,N=setTimeout(()=>{g.abort(),$n(d,"TestPingServer: timeout",!1,h)},1e4);fetch(a,{signal:g.signal}).then(D=>{clearTimeout(N),D.ok?$n(d,"TestPingServer: ok",!0,h):$n(d,"TestPingServer: server error",!1,h)}).catch(()=>{clearTimeout(N),$n(d,"TestPingServer: error",!1,h)})}function $n(a,h,d,g,N){try{N&&(N.onload=null,N.onerror=null,N.onabort=null,N.ontimeout=null),g(d)}catch{}}function CS(){this.g=new cS}function hh(a){this.i=a.Sb||null,this.h=a.ab||!1}p(hh,Om),hh.prototype.g=function(){return new ol(this.i,this.h)};function ol(a,h){Ze.call(this),this.H=a,this.o=h,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}p(ol,Ze),t=ol.prototype,t.open=function(a,h){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=a,this.D=h,this.readyState=1,ho(this)},t.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const h={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};a&&(h.body=a),(this.H||o).fetch(new Request(this.D,h)).then(this.Pa.bind(this),this.ga.bind(this))},t.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,co(this)),this.readyState=0},t.Pa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,ho(this)),this.g&&(this.readyState=3,ho(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof o.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;og(this)}else a.text().then(this.Oa.bind(this),this.ga.bind(this))};function og(a){a.j.read().then(a.Ma.bind(a)).catch(a.ga.bind(a))}t.Ma=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var h=a.value?a.value:new Uint8Array(0);(h=this.B.decode(h,{stream:!a.done}))&&(this.response=this.responseText+=h)}a.done?co(this):ho(this),this.readyState==3&&og(this)}},t.Oa=function(a){this.g&&(this.response=this.responseText=a,co(this))},t.Na=function(a){this.g&&(this.response=a,co(this))},t.ga=function(){this.g&&co(this)};function co(a){a.readyState=4,a.l=null,a.j=null,a.B=null,ho(a)}t.setRequestHeader=function(a,h){this.A.append(a,h)},t.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},t.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],h=this.h.entries();for(var d=h.next();!d.done;)d=d.value,a.push(d[0]+": "+d[1]),d=h.next();return a.join(`\r
...
`}),h}function dh(a,h,d){e:{for(g in d){var g=!1;break e}g=!0}g||(d=ag(d),typeof a=="string"?d!=null&&ro(d):ge(a,h,d))}function Ce(a){Ze.call(this),this.headers=new Map,this.L=a||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}p(Ce,Ze);var kS=/^https?$/i,xS=["POST","PUT"];t=Ce.prototype,t.Fa=function(a){this.H=a},t.ea=function(a,h,d,g){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);h=h?h.toUpperCase():"GET",this.D=a,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():zm.g(),this.g.onreadystatechange=m(c(this.Ca,this));try{this.B=!0,this.g.open(h,String(a),!0),this.B=!1}catch(D){lg(this,D);return}if(a=d||"",d=new Map(this.headers),g)if(Object.getPrototypeOf(g)===Object.prototype)for(var N in g)d.set(N,g[N]);else if(typeof g.keys=="function"&&typeof g.get=="function")for(const D of g.keys())d.set(D,g.get(D));else throw Error("Unknown input type for opt_headers: "+String(g));g=Array.from(d.keys()).find(D=>D.toLowerCase()=="content-type"),N=o.FormData&&a instanceof o.FormData,!(Array.prototype.indexOf.call(xS,h,void 0)>=0)||g||N||d.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[D,j]of d)this.g.setRequestHeader(D,j);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(a),this.v=!1}catch(D){lg(this,D)}};function lg(a,h){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=h,a.o=5,ug(a),al(a)}function ug(a){a.A||(a.A=!0,lt(a,"complete"),lt(a,"error"))}t.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=a||7,lt(this,"complete"),lt(this,"abort"),al(this))},t.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),al(this,!0)),Ce.Z.N.call(this)},t.Ca=function(){this.u||(this.B||this.v||this.j?cg(this):this.Xa())},t.Xa=function(){cg(this)};function cg(a){if(a.h&&typeof s<"u"){if(a.v&&qn(a)==4)setTimeout(a.Ca.bind(a),0);else if(lt(a,"readystatechange"),qn(a)==4){a.h=!1;try{const D=a.ca();e:switch(D){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var h=!0;break e;default:h=!1}var d;if(!(d=h)){var g;if(g=D===0){let j=String(a.D).match(Zm)[1]||null;!j&&o.self&&o.self.location&&(j=o.self.location.protocol.slice(0,-1)),g=!kS.test(j?j.toLowerCase():"")}d=g}if(d)lt(a,"complete"),lt(a,"success");else{a.o=6;try{var N=qn(a)>2?a.g.statusText:""}catch{N=""}a.l=N+" ["+a.ca()+"]",ug(a)}}finally{al(a)}}}}function al(a,h){if(a.g){a.m&&(clearTimeout(a.m),a.m=null);const d=a.g;a.g=null,h||lt(a,"ready");try{d.onreadystatechange=null}catch{}}}t.isActive=function(){return!!this.g};function qn(a){return a.g?a.g.readyState:0}t.ca=function(){try{return qn(this)>2?this.g.status:-1}catch{return-1}},t.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},t.La=function(a){if(this.g){var h=this.g.responseText;return a&&h.indexOf(a)==0&&(h=h.substring(a.length)),uS(h)}};function hg(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.F){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function NS(a){const h={};a=(a.g&&qn(a)>=2&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let g=0;g<a.length;g++){if(I(a[g]))continue;var d=mS(a[g]);const N=d[0];if(d=d[1],typeof d!="string")continue;d=d.trim();const D=h[N]||[];h[N]=D,D.push(d)}Z(h,function(g){return g.join(", ")})}t.ya=function(){return this.o},t.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function fo(a,h,d){return d&&d.internalChannelParams&&d.internalChannelParams[a]||h}function dg(a){this.za=0,this.i=[],this.j=new no,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=fo("failFast",!1,a),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=fo("baseRetryDelayMs",5e3,a),this.Za=fo("retryDelaySeedMs",1e4,a),this.Ta=fo("forwardChannelMaxRetries",2,a),this.va=fo("forwardChannelRequestTimeoutMs",2e4,a),this.ma=a&&a.xmlHttpFactory||void 0,this.Ua=a&&a.Rb||void 0,this.Aa=a&&a.useFetchStreams||!1,this.O=void 0,this.L=a&&a.supportsCrossDomainXhr||!1,this.M="",this.h=new Wm(a&&a.concurrentRequestLimit),this.Ba=new CS,this.S=a&&a.fastHandshake||!1,this.R=a&&a.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=a&&a.Pb||!1,a&&a.ua&&this.j.ua(),a&&a.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&a&&a.detectBufferingProxy||!1,this.ia=void 0,a&&a.longPollingTimeout&&a.longPollingTimeout>0&&(this.ia=a.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}t=dg.prototype,t.ka=8,t.I=1,t.connect=function(a,h,d,g){ut(0),this.W=a,this.H=h||{},d&&g!==void 0&&(this.H.OSID=d,this.H.OAID=g),this.F=this.X,this.J=Eg(this,null,this.W),ul(this)};function fh(a){if(fg(a),a.I==3){var h=a.V++,d=nn(a.J);if(ge(d,"SID",a.M),ge(d,"RID",h),ge(d,"TYPE","terminate"),po(a,d),h=new jn(a,a.j,h),h.M=2,h.A=sl(nn(d)),d=!1,o.navigator&&o.navigator.sendBeacon)try{d=o.navigator.sendBeacon(h.A.toString(),"")}catch{}!d&&o.Image&&(new Image().src=h.A,d=!0),d||(h.g=Ig(h.j,null),h.g.ea(h.A)),h.F=Date.now(),il(h)}wg(a)}function ll(a){a.g&&(mh(a),a.g.cancel(),a.g=null)}function fg(a){ll(a),a.v&&(o.clearTimeout(a.v),a.v=null),cl(a),a.h.cancel(),a.m&&(typeof a.m=="number"&&o.clearTimeout(a.m),a.m=null)}function ul(a){if(!Qm(a.h)&&!a.m){a.m=!0;var h=a.Ea;M||y(),L||(M(),L=!0),_.add(h,a),a.D=0}}function DS(a,h){return Ym(a.h)>=a.h.j-(a.m?1:0)?!1:a.m?(a.i=h.G.concat(a.i),!0):a.I==1||a.I==2||a.D>=(a.Sa?0:a.Ta)?!1:(a.m=to(c(a.Ea,a,h),vg(a,a.D)),a.D++,!0)}t.Ea=function(a){if(this.m)if(this.m=null,this.I==1){if(!a){this.V=Math.floor(Math.random()*1e5),a=this.V++;const N=new jn(this,this.j,a);let D=this.o;if(this.U&&(D?(D=ve(D),Or(D,this.U)):D=this.U),this.u!==null||this.R||(N.J=D,D=null),this.S)e:{for(var h=0,d=0;d<this.i.length;d++){t:{var g=this.i[d];if("__data__"in g.map&&(g=g.map.__data__,typeof g=="string")){g=g.length;break t}g=void 0}if(g===void 0)break;if(h+=g,h>4096){h=d;break e}if(h===4096||d===this.i.length-1){h=d+1;break e}}h=1e3}else h=1e3;h=mg(this,N,h),d=nn(this.J),ge(d,"RID",a),ge(d,"CVER",22),this.G&&ge(d,"X-HTTP-Session-Id",this.G),po(this,d),D&&(this.R?h="headers="+ro(ag(D))+"&"+h:this.u&&dh(d,this.u,D)),uh(this.h,N),this.Ra&&ge(d,"TYPE","init"),this.S?(ge(d,"$req",h),ge(d,"SID","null"),N.U=!0,sh(N,d,null)):sh(N,d,h),this.I=2}}else this.I==3&&(a?pg(this,a):this.i.length==0||Qm(this.h)||pg(this))};function pg(a,h){var d;h?d=h.l:d=a.V++;const g=nn(a.J);ge(g,"SID",a.M),ge(g,"RID",d),ge(g,"AID",a.K),po(a,g),a.u&&a.o&&dh(g,a.u,a.o),d=new jn(a,a.j,d,a.D+1),a.u===null&&(d.J=a.o),h&&(a.i=h.G.concat(a.i)),h=mg(a,d,1e3),d.H=Math.round(a.va*.5)+Math.round(a.va*.5*Math.random()),uh(a.h,d),sh(d,g,h)}function po(a,h){a.H&&Y(a.H,function(d,g){ge(h,g,d)}),a.l&&Y({},function(d,g){ge(h,g,d)})}function mg(a,h,d){d=Math.min(a.i.length,d);const g=a.l?c(a.l.Ka,a.l,a):null;e:{var N=a.i;let ee=-1;for(;;){const Fe=["count="+d];ee==-1?d>0?(ee=N[0].g,Fe.push("ofs="+ee)):ee=0:Fe.push("ofs="+ee);let pe=!0;for(let $e=0;$e<d;$e++){var D=N[$e].g;const rn=N[$e].map;if(D-=ee,D<0)ee=Math.max(0,N[$e].g-100),pe=!1;else try{D="req"+D+"_"||"";try{var j=rn instanceof Map?rn:Object.entries(rn);for(const[jr,Hn]of j){let Gn=Hn;l(Hn)&&(Gn=eh(Hn)),Fe.push(D+jr+"="+encodeURIComponent(Gn))}}catch(jr){throw Fe.push(D+"type="+encodeURIComponent("_badmap")),jr}}catch{g&&g(rn)}}if(pe){j=Fe.join("&");break e}}j=void 0}return a=a.i.splice(0,d),h.G=a,j}function gg(a){if(!a.g&&!a.v){a.Y=1;var h=a.Da;M||y(),L||(M(),L=!0),_.add(h,a),a.A=0}}function ph(a){return a.g||a.v||a.A>=3?!1:(a.Y++,a.v=to(c(a.Da,a),vg(a,a.A)),a.A++,!0)}t.Da=function(){if(this.v=null,yg(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var a=4*this.T;this.j.info("BP detection timer enabled: "+a),this.B=to(c(this.Wa,this),a)}},t.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,ut(10),ll(this),yg(this))};function mh(a){a.B!=null&&(o.clearTimeout(a.B),a.B=null)}function yg(a){a.g=new jn(a,a.j,"rpc",a.Y),a.u===null&&(a.g.J=a.o),a.g.P=0;var h=nn(a.na);ge(h,"RID","rpc"),ge(h,"SID",a.M),ge(h,"AID",a.K),ge(h,"CI",a.F?"0":"1"),!a.F&&a.ia&&ge(h,"TO",a.ia),ge(h,"TYPE","xmlhttp"),po(a,h),a.u&&a.o&&dh(h,a.u,a.o),a.O&&(a.g.H=a.O);var d=a.g;a=a.ba,d.M=1,d.A=sl(nn(h)),d.u=null,d.R=!0,Hm(d,a)}t.Va=function(){this.C!=null&&(this.C=null,ll(this),ph(this),ut(19))};function cl(a){a.C!=null&&(o.clearTimeout(a.C),a.C=null)}function _g(a,h){var d=null;if(a.g==h){cl(a),mh(a),a.g=null;var g=2}else if(lh(a.h,h))d=h.G,Xm(a.h,h),g=1;else return;if(a.I!=0){if(h.o)if(g==1){d=h.u?h.u.length:0,h=Date.now()-h.F;var N=a.D;g=nl(),lt(g,new Bm(g,d)),ul(a)}else gg(a);else if(N=h.m,N==3||N==0&&h.X>0||!(g==1&&DS(a,h)||g==2&&ph(a)))switch(d&&d.length>0&&(h=a.h,h.i=h.i.concat(d)),N){case 1:Br(a,5);break;case 4:Br(a,10);break;case 3:Br(a,6);break;default:Br(a,2)}}}function vg(a,h){let d=a.Qa+Math.floor(Math.random()*a.Za);return a.isActive()||(d*=2),d*h}function Br(a,h){if(a.j.info("Error code "+h),h==2){var d=c(a.bb,a),g=a.Ua;const N=!g;g=new zn(g||"//www.google.com/images/cleardot.gif"),o.location&&o.location.protocol=="http"||so(g,"https"),sl(g),N?PS(g.toString(),d):RS(g.toString(),d)}else ut(2);a.I=0,a.l&&a.l.pa(h),wg(a),fg(a)}t.bb=function(a){a?(this.j.info("Successfully pinged google.com"),ut(2)):(this.j.info("Failed to ping google.com"),ut(1))};function wg(a){if(a.I=0,a.ja=[],a.l){const h=Jm(a.h);(h.length!=0||a.i.length!=0)&&(R(a.ja,h),R(a.ja,a.i),a.h.i.length=0,w(a.i),a.i.length=0),a.l.oa()}}function Eg(a,h,d){var g=d instanceof zn?nn(d):new zn(d);if(g.g!="")h&&(g.g=h+"."+g.g),oo(g,g.u);else{var N=o.location;g=N.protocol,h=h?h+"."+N.hostname:N.hostname,N=+N.port;const D=new zn(null);g&&so(D,g),h&&(D.g=h),N&&oo(D,N),d&&(D.h=d),g=D}return d=a.G,h=a.wa,d&&h&&ge(g,d,h),ge(g,"VER",a.ka),po(a,g),g}function Ig(a,h,d){if(h&&!a.L)throw Error("Can't create secondary domain capable XhrIo object.");return h=a.Aa&&!a.ma?new Ce(new hh({ab:d})):new Ce(a.ma),h.Fa(a.L),h}t.isActive=function(){return!!this.l&&this.l.isActive(this)};function Tg(){}t=Tg.prototype,t.ra=function(){},t.qa=function(){},t.pa=function(){},t.oa=function(){},t.isActive=function(){return!0},t.Ka=function(){};function hl(){}hl.prototype.g=function(a,h){return new Tt(a,h)};function Tt(a,h){Ze.call(this),this.g=new dg(h),this.l=a,this.h=h&&h.messageUrlParams||null,a=h&&h.messageHeaders||null,h&&h.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=h&&h.initMessageHeaders||null,h&&h.messageContentType&&(a?a["X-WebChannel-Content-Type"]=h.messageContentType:a={"X-WebChannel-Content-Type":h.messageContentType}),h&&h.sa&&(a?a["X-WebChannel-Client-Profile"]=h.sa:a={"X-WebChannel-Client-Profile":h.sa}),this.g.U=a,(a=h&&h.Qb)&&!I(a)&&(this.g.u=a),this.A=h&&h.supportsCrossDomainXhr||!1,this.v=h&&h.sendRawJson||!1,(h=h&&h.httpSessionIdParam)&&!I(h)&&(this.g.G=h,a=this.h,a!==null&&h in a&&(a=this.h,h in a&&delete a[h])),this.j=new Oi(this)}p(Tt,Ze),Tt.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},Tt.prototype.close=function(){fh(this.g)},Tt.prototype.o=function(a){var h=this.g;if(typeof a=="string"){var d={};d.__data__=a,a=d}else this.v&&(d={},d.__data__=eh(a),a=d);h.i.push(new _S(h.Ya++,a)),h.I==3&&ul(h)},Tt.prototype.N=function(){this.g.l=null,delete this.j,fh(this.g),delete this.g,Tt.Z.N.call(this)};function Sg(a){th.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var h=a.__sm__;if(h){e:{for(const d in h){a=d;break e}a=void 0}(this.i=a)&&(a=this.i,h=h!==null&&a in h?h[a]:void 0),this.data=h}else this.data=a}p(Sg,th);function Ag(){nh.call(this),this.status=1}p(Ag,nh);function Oi(a){this.g=a}p(Oi,Tg),Oi.prototype.ra=function(){lt(this.g,"a")},Oi.prototype.qa=function(a){lt(this.g,new Sg(a))},Oi.prototype.pa=function(a){lt(this.g,new Ag)},Oi.prototype.oa=function(){lt(this.g,"b")},hl.prototype.createWebChannel=hl.prototype.g,Tt.prototype.send=Tt.prototype.o,Tt.prototype.open=Tt.prototype.m,Tt.prototype.close=Tt.prototype.close,KI=function(){return new hl},GI=function(){return nl()},HI=Lr,sf={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},rl.NO_ERROR=0,rl.TIMEOUT=8,rl.HTTP_ERROR=6,tu=rl,jm.COMPLETE="complete",qI=jm,Mm.EventType=Zs,Zs.OPEN="a",Zs.CLOSE="b",Zs.ERROR="c",Zs.MESSAGE="d",Ze.prototype.listen=Ze.prototype.J,Vo=Mm,Ce.prototype.listenOnce=Ce.prototype.K,Ce.prototype.getLastError=Ce.prototype.Ha,Ce.prototype.getLastErrorCode=Ce.prototype.ya,Ce.prototype.getStatus=Ce.prototype.ca,Ce.prototype.getResponseJson=Ce.prototype.La,Ce.prototype.getResponseText=Ce.prototype.la,Ce.prototype.send=Ce.prototype.ea,Ce.prototype.setWithCredentials=Ce.prototype.Fa,$I=Ce}).apply(typeof Nl<"u"?Nl:typeof self<"u"?self:typeof window<"u"?window:{});/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _i=new Pp("@firebase/firestore");function $i(){return _i.logLevel}function F(t,...e){if(_i.logLevel<=re.DEBUG){const n=e.map(Up);_i.debug(`Firestore (${Ks}): ${t}`,...n)}}function ht(t,...e){if(_i.logLevel<=re.ERROR){const n=e.map(Up);_i.error(`Firestore (${Ks}): ${t}`,...n)}}function vi(t,...e){if(_i.logLevel<=re.WARN){const n=e.map(Up);_i.warn(`Firestore (${Ks}): ${t}`,...n)}}function Up(t){if(typeof t=="string")return t;try{return function(n){return JSON.stringify(n)}(t)}catch{return t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oe(t,e){const n={typeString:t};return e&&(n.value=e),n}function Ga(t,e){if(!JI(t))throw new z(b.INVALID_ARGUMENT,"JSON must be an object");let n;for(const r in e)if(e[r]){const i=e[r].typeString,s="value"in e[r]?{value:e[r].value}:void 0;if(!(r in t)){n=`JSON missing required field: '${r}'`;break}const o=t[r];if(i&&typeof o!==i){n=`JSON field '${r}' must be a ${i}.`;break}if(s!==void 0&&o!==s.value){n=`Expected '${r}' field to equal '${s.value}'`;break}}if(n)throw new z(b.INVALID_ARGUMENT,n);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xi(t){if(t.code!==b.FAILED_PRECONDITION||t.message!==eT)throw t;F("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const At="SimpleDb";class Cc{static open(e,n,r,i){try{return new Cc(n,e.transaction(i,r))}catch(s){throw new Yo(n,s)}}constructor(e,n){this.action=e,this.transaction=n,this.aborted=!1,this.S=new Er,this.transaction.oncomplete=()=>{this.S.resolve()},this.transaction.onabort=()=>{n.error?this.S.reject(new Yo(e,n.error)):this.S.resolve()},this.transaction.onerror=r=>{const i=zp(r.target.error);this.S.reject(new Yo(e,i))}}get D(){return this.S.promise}abort(e){e&&this.S.reject(e),this.aborted||(F(At,"Aborting transaction:",e?e.message:"Client-initiated abort"),this.aborted=!0,this.transaction.abort())}C(){const e=this.transaction;this.aborted||typeof e.commit!="function"||e.commit()}store(e){const n=this.transaction.objectStore(e);return new rx(n)}}class Ir{static delete(e){return F(At,"Removing database:",e),Wr(YE().indexedDB.deleteDatabase(e)).toPromise()}static v(){if(!sI())return!1;if(Ir.F())return!0;const e=je(),n=Ir.M(e),r=0<n&&n<10,i=nT(e),s=0<i&&i<4.5;return!(e.indexOf("MSIE ")>0||e.indexOf("Trident/")>0||e.indexOf("Edge/")>0||r||s)}static F(){var e;return typeof process<"u"&&((e=process.__PRIVATE_env)==null?void 0:e.__PRIVATE_USE_MOCK_PERSISTENCE)==="YES"}static O(e,n){return e.store(n)}static M(e){const n=e.match(/i(?:phone|pad|pod) os ([\d_]+)/i),r=n?n[1].split("_").slice(0,2).join("."):"-1";return Number(r)}constructor(e,n,r){this.name=e,this.version=n,this.N=r,this.B=null,Ir.M(je())===12.2&&ht("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.")}async L(e){return this.db||(F(At,"Opening database:",this.name),this.db=await new Promise((n,r)=>{const i=indexedDB.open(this.name,this.version);i.onsuccess=s=>{const o=s.target.result;n(o)},i.onblocked=()=>{r(new Yo(e,"Cannot upgrade IndexedDB schema while another tab is open. Close all tabs that access Firestore and reload this page to proceed."))},i.onerror=s=>{const o=s.target.error;o.name==="VersionError"?r(new z(b.FAILED_PRECONDITION,"A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")):o.name==="InvalidStateError"?r(new z(b.FAILED_PRECONDITION,"Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: "+o)):r(new Yo(e,o))},i.onupgradeneeded=s=>{F(At,'Database "'+this.name+'" requires upgrade from version:',s.oldVersion);const o=s.target.result;this.N.k(o,i.transaction,s.oldVersion,this.version).next(()=>{F(At,"Database upgrade to version "+this.version+" complete")})}})),this.K&&(this.db.onversionchange=n=>this.K(n)),this.db}q(e){this.K=e,this.db&&(this.db.onversionchange=n=>e(n))}async runTransaction(e,n,r,i){const s=n==="readonly";let o=0;for(;;){++o;try{this.db=await this.L(e);const l=Cc.open(this.db,e,s?"readonly":"readwrite",r),u=i(l).next(c=>(l.C(),c)).catch(c=>(l.abort(c),k.reject(c))).toPromise();return u.catch(()=>{}),await l.D,u}catch(l){const u=l,c=u.name!=="FirebaseError"&&o<3;if(F(At,"Transaction failed with error:",u.message,"Retrying:",c),this.close(),!c)return Promise.reject(u)}}}close(){this.db&&this.db.close(),this.db=void 0}}function nT(t){const e=t.match(/Android ([\d.]+)/i),n=e?e[1].split(".").slice(0,2).join("."):"-1";return Number(n)}class nx{constructor(e){this.U=e,this.$=!1,this.W=null}get isDone(){return this.$}get G(){return this.W}set cursor(e){this.U=e}done(){this.$=!0}j(e){this.W=e}delete(){return Wr(this.U.delete())}}class Yo extends z{constructor(e,n){super(b.UNAVAILABLE,`IndexedDB transaction '${e}' failed: ${n}`),this.name="IndexedDbTransactionError"}}function Vr(t){return t.name==="IndexedDbTransactionError"}class rx{constructor(e){this.store=e}put(e,n){let r;return n!==void 0?(F(At,"PUT",this.store.name,e,n),r=this.store.put(n,e)):(F(At,"PUT",this.store.name,"<auto-key>",e),r=this.store.put(e)),Wr(r)}add(e){return F(At,"ADD",this.store.name,e,e),Wr(this.store.add(e))}get(e){return Wr(this.store.get(e)).next(n=>(n===void 0&&(n=null),F(At,"GET",this.store.name,e,n),n))}delete(e){return F(At,"DELETE",this.store.name,e),Wr(this.store.delete(e))}count(){return F(At,"COUNT",this.store.name),Wr(this.store.count())}H(e,n){const r=this.options(e,n),i=r.index?this.store.index(r.index):this.store;if(typeof i.getAll=="function"){const s=i.getAll(r.range);return new k((o,l)=>{s.onerror=u=>{l(u.target.error)},s.onsuccess=u=>{o(u.target.result)}})}{const s=this.cursor(r),o=[];return this.J(s,(l,u)=>{o.push(u)}).next(()=>o)}}Z(e,n){const r=this.store.getAll(e,n===null?void 0:n);return new k((i,s)=>{r.onerror=o=>{s(o.target.error)},r.onsuccess=o=>{i(o.target.result)}})}X(e,n){F(At,"DELETE ALL",this.store.name);const r=this.options(e,n);r.Y=!1;const i=this.cursor(r);return this.J(i,(s,o,l)=>l.delete())}ee(e,n){let r;n?r=e:(r={},n=e);const i=this.cursor(r);return this.J(i,n)}te(e){const n=this.cursor({});return new k((r,i)=>{n.onerror=s=>{const o=zp(s.target.error);i(o)},n.onsuccess=s=>{const o=s.target.result;o?e(o.primaryKey,o.value).next(l=>{l?o.continue():r()}):r()}})}J(e,n){const r=[];return new k((i,s)=>{e.onerror=o=>{s(o.target.error)},e.onsuccess=o=>{const l=o.target.result;if(!l)return void i();const u=new nx(l),c=n(l.primaryKey,l.value,u);if(c instanceof k){const f=c.catch(p=>(u.done(),k.reject(p)));r.push(f)}u.isDone?i():u.G===null?l.continue():l.continue(u.G)}}).next(()=>k.waitFor(r))}options(e,n){let r;return e!==void 0&&(typeof e=="string"?r=e:n=e),{index:r,range:n}}cursor(e){let n="next";if(e.reverse&&(n="prev"),e.index){const r=this.store.index(e.index);return e.Y?r.openKeyCursor(e.range,n):r.openCursor(e.range,n)}return this.store.openCursor(e.range,n)}}function Wr(t){return new k((e,n)=>{t.onsuccess=r=>{const i=r.target.result;e(i)},t.onerror=r=>{const i=zp(r.target.error);n(i)}})}let g_=!1;function zp(t){const e=Ir.M(je());if(e>=12.2&&e<13){const n="An internal error was encountered in the Indexed Database server";if(t.message.indexOf(n)>=0){const r=new z("internal",`IOS_INDEXEDDB_BUG1: IndexedDb has thrown '${n}'. This is likely due to an unavoidable bug in iOS. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.`);return g_||(g_=!0,setTimeout(()=>{throw r},0)),r}}return t}const Xo="IndexBackfiller";class ix{constructor(e,n){this.asyncQueue=e,this.ne=n,this.task=null}start(){this.re(15e3)}stop(){this.task&&(this.task.cancel(),this.task=null)}get started(){return this.task!==null}re(e){F(Xo,`Scheduled in ${e}ms`),this.task=this.asyncQueue.enqueueAfterDelay("index_backfill",e,async()=>{this.task=null;try{const n=await this.ne.ie();F(Xo,`Documents written: ${n}`)}catch(n){Vr(n)?F(Xo,"Ignoring IndexedDB error during index backfill: ",n):await xi(n)}await this.re(6e4)})}}class sx{constructor(e,n){this.localStore=e,this.persistence=n}async ie(e=50){return this.persistence.runTransaction("Backfill Indexes","readwrite-primary",n=>this.se(n,e))}se(e,n){const r=new Set;let i=n,s=!0;return k.doWhile(()=>s===!0&&i>0,()=>this.localStore.indexManager.getNextCollectionGroupToUpdate(e).next(o=>{if(o!==null&&!r.has(o))return F(Xo,`Processing collection: ${o}`),this.oe(e,o,i).next(l=>{i-=l,r.add(o)});s=!1})).next(()=>n-i)}oe(e,n,r){return this.localStore.indexManager.getMinOffsetFromCollectionGroup(e,n).next(i=>this.localStore.localDocuments.getNextDocuments(e,n,i,r).next(s=>{const o=s.changes;return this.localStore.indexManager.updateIndexEntries(e,o).next(()=>this._e(i,s)).next(l=>(F(Xo,`Updating offset: ${l}`),this.localStore.indexManager.updateCollectionGroup(e,n,l))).next(()=>o.size)}))}_e(e,n){let r=e;return n.changes.forEach((i,s)=>{const o=ZI(s);jp(o,r)>0&&(r=o)}),new xt(r.readTime,r.documentKey,Math.max(n.batchId,e.largestBatchId))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bx{constructor(e,n,r,i,s,o,l,u,c,f,p){this.databaseId=e,this.appId=n,this.persistenceKey=r,this.host=i,this.ssl=s,this.forceLongPolling=o,this.autoDetectLongPolling=l,this.longPollingOptions=u,this.useFetchStreams=c,this.isUsingEmulator=f,this.apiKey=p}}const Qu="(default)";class wi{constructor(e,n){this.projectId=e,this.database=n||Qu}static empty(){return new wi("","")}get isDefaultDatabase(){return this.database===Qu}isEqual(e){return e instanceof wi&&e.projectId===this.projectId&&e.database===this.database}}function Ox(t,e){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new z(b.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new wi(t.options.projectId,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hx{constructor(e,n=null,r=[],i=[],s=null,o=null,l=null){this.path=e,this.collectionGroup=n,this.orderBy=r,this.filters=i,this.limit=s,this.startAt=o,this.endAt=l,this.Te=null}}function gf(t,e=null,n=[],r=[],i=null,s=null,o=null){return new Hx(t,e,n,r,i,s,o)}function Ei(t){const e=J(t);if(e.Te===null){let n=e.path.canonicalString();e.collectionGroup!==null&&(n+="|cg:"+e.collectionGroup),n+="|f:",n+=e.filters.map(r=>mf(r)).join(","),n+="|ob:",n+=e.orderBy.map(r=>function(s){return s.field.canonicalString()+s.dir}(r)).join(","),kc(e.limit)||(n+="|l:",n+=e.limit),e.startAt&&(n+="|lb:",n+=e.startAt.inclusive?"b:":"a:",n+=e.startAt.position.map(r=>Vs(r)).join(",")),e.endAt&&(n+="|ub:",n+=e.endAt.inclusive?"a:":"b:",n+=e.endAt.position.map(r=>Vs(r)).join(",")),e.Te=n}return e.Te}function Wa(t,e){if(t.limit!==e.limit||t.orderBy.length!==e.orderBy.length)return!1;for(let n=0;n<t.orderBy.length;n++)if(!Fx(t.orderBy[n],e.orderBy[n]))return!1;if(t.filters.length!==e.filters.length)return!1;for(let n=0;n<t.filters.length;n++)if(!AT(t.filters[n],e.filters[n]))return!1;return t.collectionGroup===e.collectionGroup&&!!t.path.isEqual(e.path)&&!!k_(t.startAt,e.startAt)&&k_(t.endAt,e.endAt)}function Yu(t){return $.isDocumentKey(t.path)&&t.collectionGroup===null&&t.filters.length===0}function Xu(t,e){return t.filters.filter(n=>n instanceof ie&&n.field.isEqual(e))}function x_(t,e,n){let r=su,i=!0;for(const s of Xu(t,e)){let o=su,l=!0;switch(s.op){case"<":case"<=":o=Mx(s.value);break;case"==":case"in":case">=":o=s.value;break;case">":o=s.value,l=!1;break;case"!=":case"not-in":o=su}P_({value:r,inclusive:i},{value:o,inclusive:l})<0&&(r=o,i=l)}if(n!==null){for(let s=0;s<t.orderBy.length;++s)if(t.orderBy[s].field.isEqual(e)){const o=n.position[s];P_({value:r,inclusive:i},{value:o,inclusive:n.inclusive})<0&&(r=o,i=n.inclusive);break}}return{value:r,inclusive:i}}function N_(t,e,n){let r=lr,i=!0;for(const s of Xu(t,e)){let o=lr,l=!0;switch(s.op){case">=":case">":o=Lx(s.value),l=!1;break;case"==":case"in":case"<=":o=s.value;break;case"<":o=s.value,l=!1;break;case"!=":case"not-in":o=lr}R_({value:r,inclusive:i},{value:o,inclusive:l})>0&&(r=o,i=l)}if(n!==null){for(let s=0;s<t.orderBy.length;++s)if(t.orderBy[s].field.isEqual(e)){const o=n.position[s];R_({value:r,inclusive:i},{value:o,inclusive:n.inclusive})>0&&(r=o,i=n.inclusive);break}}return{value:r,inclusive:i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bc{constructor(e,n,r,i,s){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=r,this.documentUpdates=i,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,n,r){const i=new Map;return i.set(e,Ya.createSynthesizedTargetChangeForCurrentChange(e,n,r)),new Bc(W.min(),i,new Ie(X),Rt(),te())}}class Ya{constructor(e,n,r,i,s){this.resumeToken=e,this.current=n,this.addedDocuments=r,this.modifiedDocuments=i,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,n,r){return new Ya(r,n,te(),te(),te())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function u0(t){var n,r;if(K(t instanceof ie||t instanceof he,20012),t instanceof ie){if(t instanceof kT){const i=((r=(n=t.value.arrayValue)==null?void 0:n.values)==null?void 0:r.map(s=>ie.create(t.field,"==",s)))||[];return he.create(i,"or")}return t}const e=t.filters.map(i=>u0(i));return he.create(e,t.op)}function ON(t){if(t.getFilters().length===0)return[];const e=Af(u0(t));return K(c0(e),7391),Tf(e)||Sf(e)?[e]:e.getFilters()}function Tf(t){return t instanceof ie}function Sf(t){return t instanceof he&&Yp(t)}function c0(t){return Tf(t)||Sf(t)||function(n){if(n instanceof he&&pf(n)){for(const r of n.getFilters())if(!Tf(r)&&!Sf(r))return!1;return!0}return!1}(t)}function Af(t){if(K(t instanceof ie||t instanceof he,34018),t instanceof ie)return t;if(t.filters.length===1)return Af(t.filters[0]);const e=t.filters.map(r=>Af(r));let n=he.create(e,t.op);return n=tc(n),c0(n)?n:(K(n instanceof he,64498),K(Os(n),40251),K(n.filters.length>1,57927),n.filters.reduce((r,i)=>rm(r,i)))}function rm(t,e){let n;return K(t instanceof ie||t instanceof he,38388),K(e instanceof ie||e instanceof he,25473),n=t instanceof ie?e instanceof ie?function(i,s){return he.create([i,s],"and")}(t,e):X_(t,e):e instanceof ie?X_(e,t):function(i,s){if(K(i.filters.length>0&&s.filters.length>0,48005),Os(i)&&Os(s))return PT(i,s.getFilters());const o=pf(i)?i:s,l=pf(i)?s:i,u=o.filters.map(c=>rm(c,l));return he.create(u,"or")}(t,e),tc(n)}function X_(t,e){if(Os(e))return PT(e,t.getFilters());{const n=e.filters.map(r=>rm(t,r));return he.create(n,"or")}}function tc(t){if(K(t instanceof ie||t instanceof he,11850),t instanceof ie)return t;const e=t.getFilters();if(e.length===1)return tc(e[0]);if(ST(t))return t;const n=e.map(i=>tc(i)),r=[];return n.forEach(i=>{i instanceof ie?r.push(i):i instanceof he&&(i.op===t.op?r.push(...i.filters):r.push(i))}),r.length===1?r[0]:he.create(r,t.op)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const J_="IndexedDbIndexManager",bl=new Uint8Array(0);class LN{constructor(e,n){this.databaseId=n,this.Dn=new im,this.Cn=new Fn(r=>Ei(r),(r,i)=>Wa(r,i)),this.uid=e.uid||""}addToCollectionParentIndex(e,n){if(!this.Dn.has(n)){const r=n.lastSegment(),i=n.popLast();e.addOnCommittedListener(()=>{this.Dn.add(n)});const s={collectionId:r,parent:ot(i)};return Z_(e).put(s)}return k.resolve()}getCollectionParents(e,n){const r=[],i=IDBKeyRange.bound([n,""],[YI(n),""],!1,!0);return Z_(e).H(i).next(s=>{for(const o of s){if(o.collectionId!==n)break;r.push(un(o.parent))}return r})}addFieldIndex(e,n){const r=Ao(e),i=function(l){return{indexId:l.indexId,collectionGroup:l.collectionGroup,fields:l.fields.map(u=>[u.fieldPath.canonicalString(),u.kind])}}(n);delete i.indexId;const s=r.add(i);if(n.indexState){const o=ji(e);return s.next(l=>{o.put(q_(l,this.uid,n.indexState.sequenceNumber,n.indexState.offset))})}return s.next()}deleteFieldIndex(e,n){const r=Ao(e),i=ji(e),s=Bi(e);return r.delete(n.indexId).next(()=>i.delete(IDBKeyRange.bound([n.indexId],[n.indexId+1],!1,!0))).next(()=>s.delete(IDBKeyRange.bound([n.indexId],[n.indexId+1],!1,!0)))}deleteAllFieldIndexes(e){const n=Ao(e),r=Bi(e),i=ji(e);return n.X().next(()=>r.X()).next(()=>i.X())}createTargetIndexes(e,n){return k.forEach(this.vn(n),r=>this.getIndexType(e,r).next(i=>{if(i===0||i===1){const s=new Y_(r).bn();if(s!=null)return this.addFieldIndex(e,s)}}))}getDocumentsMatchingTarget(e,n){const r=Bi(e);let i=!0;const s=new Map;return k.forEach(this.vn(n),o=>this.Fn(e,o).next(l=>{i&&(i=!!l),s.set(o,l)})).next(()=>{if(i){let o=te();const l=[];return k.forEach(s,(u,c)=>{F(J_,`Using index ${function(A){return`id=${A.indexId}|cg=${A.collectionGroup}|f=${A.fields.map(V=>`${V.fieldPath}:${V.kind}`).join(",")}`}(u)} to execute ${Ei(n)}`);const f=function(A,V){const M=af(V);if(M===void 0)return null;for(const L of Xu(A,M.fieldPath))switch(L.op){case"array-contains-any":return L.value.arrayValue.values||[];case"array-contains":return[L.value]}return null}(c,u),p=function(A,V){const M=new Map;for(const L of Gr(V))for(const _ of Xu(A,L.fieldPath))switch(_.op){case"==":case"in":M.set(L.fieldPath.canonicalString(),_.value);break;case"not-in":case"!=":return M.set(L.fieldPath.canonicalString(),_.value),Array.from(M.values())}return null}(c,u),m=function(A,V){const M=[];let L=!0;for(const _ of Gr(V)){const y=_.kind===0?x_(A,_.fieldPath,A.startAt):N_(A,_.fieldPath,A.startAt);M.push(y.value),L&&(L=y.inclusive)}return new bs(M,L)}(c,u),w=function(A,V){const M=[];let L=!0;for(const _ of Gr(V)){const y=_.kind===0?N_(A,_.fieldPath,A.endAt):x_(A,_.fieldPath,A.endAt);M.push(y.value),L&&(L=y.inclusive)}return new bs(M,L)}(c,u),R=this.Mn(u,c,m),C=this.Mn(u,c,w),O=this.xn(u,c,p),T=this.On(u.indexId,f,R,m.inclusive,C,w.inclusive,O);return k.forEach(T,v=>r.Z(v,n.limit).next(A=>{A.forEach(V=>{const M=$.fromSegments(V.documentKey);o.has(M)||(o=o.add(M),l.push(M))})}))}).next(()=>l)}return k.resolve(null)})}vn(e){let n=this.Cn.get(e);return n||(e.filters.length===0?n=[e]:n=ON(he.create(e.filters,"and")).map(r=>gf(e.path,e.collectionGroup,e.orderBy,r.getFilters(),e.limit,e.startAt,e.endAt)),this.Cn.set(e,n),n)}On(e,n,r,i,s,o,l){const u=(n!=null?n.length:1)*Math.max(r.length,s.length),c=u/(n!=null?n.length:1),f=[];for(let p=0;p<u;++p){const m=n?this.Nn(n[p/c]):bl,w=this.Bn(e,m,r[p%c],i),R=this.Ln(e,m,s[p%c],o),C=l.map(O=>this.Bn(e,m,O,!0));f.push(...this.createRange(w,R,C))}return f}Bn(e,n,r,i){const s=new Xr(e,$.empty(),n,r);return i?s:s.En()}Ln(e,n,r,i){const s=new Xr(e,$.empty(),n,r);return i?s.En():s}Fn(e,n){const r=new Y_(n),i=n.collectionGroup!=null?n.collectionGroup:n.path.lastSegment();return this.getFieldIndexes(e,i).next(s=>{let o=null;for(const l of s)r.gn(l)&&(!o||l.fields.length>o.fields.length)&&(o=l);return o})}getIndexType(e,n){let r=2;const i=this.vn(n);return k.forEach(i,s=>this.Fn(e,s).next(o=>{o?r!==0&&o.fields.length<function(u){let c=new fe(Se.comparator),f=!1;for(const p of u.filters)for(const m of p.getFlattenedFilters())m.field.isKeyField()||(m.op==="array-contains"||m.op==="array-contains-any"?f=!0:c=c.add(m.field));for(const p of u.orderBy)p.field.isKeyField()||(c=c.add(p.field));return c.size+(f?1:0)}(s)&&(r=1):r=0})).next(()=>function(o){return o.limit!==null}(n)&&i.length>1&&r===2?1:r)}kn(e,n){const r=new So;for(const i of Gr(e)){const s=n.data.field(i.fieldPath);if(s==null)return null;const o=r.ln(i.kind);Yr.Wt.Dt(s,o)}return r.un()}Nn(e){const n=new So;return Yr.Wt.Dt(e,n.ln(0)),n.un()}Kn(e,n){const r=new So;return Yr.Wt.Dt(Na(this.databaseId,n),r.ln(function(s){const o=Gr(s);return o.length===0?0:o[o.length-1].kind}(e))),r.un()}xn(e,n,r){if(r===null)return[];let i=[];i.push(new So);let s=0;for(const o of Gr(e)){const l=r[s++];for(const u of i)if(this.qn(n,o.fieldPath)&&Da(l))i=this.Un(i,o,l);else{const c=u.ln(o.kind);Yr.Wt.Dt(l,c)}}return this.$n(i)}Mn(e,n,r){return this.xn(e,n,r.position)}$n(e){const n=[];for(let r=0;r<e.length;++r)n[r]=e[r].un();return n}Un(e,n,r){const i=[...e],s=[];for(const o of r.arrayValue.values||[])for(const l of i){const u=new So;u.seed(l.un()),Yr.Wt.Dt(o,u.ln(n.kind)),s.push(u)}return s}qn(e,n){return!!e.filters.find(r=>r instanceof ie&&r.field.isEqual(n)&&(r.op==="in"||r.op==="not-in"))}getFieldIndexes(e,n){const r=Ao(e),i=ji(e);return(n?r.H(uf,IDBKeyRange.bound(n,n)):r.H()).next(s=>{const o=[];return k.forEach(s,l=>i.get([l.indexId,this.uid]).next(u=>{o.push(function(f,p){const m=p?new Sa(p.sequenceNumber,new xt(Ti(p.readTime),new $(un(p.documentKey)),p.largestBatchId)):Sa.empty(),w=f.fields.map(([R,C])=>new nu(Se.fromServerFormat(R),C));return new Hu(f.indexId,f.collectionGroup,w,m)}(l,u))})).next(()=>o)})}getNextCollectionGroupToUpdate(e){return this.getFieldIndexes(e).next(n=>n.length===0?null:(n.sort((r,i)=>{const s=r.indexState.sequenceNumber-i.indexState.sequenceNumber;return s!==0?s:X(r.collectionGroup,i.collectionGroup)}),n[0].collectionGroup))}updateCollectionGroup(e,n,r){const i=Ao(e),s=ji(e);return this.Wn(e).next(o=>i.H(uf,IDBKeyRange.bound(n,n)).next(l=>k.forEach(l,u=>s.put(q_(u.indexId,this.uid,o,r)))))}updateIndexEntries(e,n){const r=new Map;return k.forEach(n,(i,s)=>{const o=r.get(i.collectionGroup);return(o?k.resolve(o):this.getFieldIndexes(e,i.collectionGroup)).next(l=>(r.set(i.collectionGroup,l),k.forEach(l,u=>this.Qn(e,i,u).next(c=>{const f=this.Gn(s,u);return c.isEqual(f)?k.resolve():this.zn(e,s,u,c,f)}))))})}jn(e,n,r,i){return Bi(e).put(i.Rn(this.uid,this.Kn(r,n.key),n.key))}Hn(e,n,r,i){return Bi(e).delete(i.An(this.uid,this.Kn(r,n.key),n.key))}Qn(e,n,r){const i=Bi(e);let s=new fe(Qn);return i.ee({index:aT,range:IDBKeyRange.only([r.indexId,this.uid,cu(this.Kn(r,n))])},(o,l)=>{s=s.add(new Xr(r.indexId,n,Q_(l.arrayValue),Q_(l.directionalValue)))}).next(()=>s)}Gn(e,n){let r=new fe(Qn);const i=this.kn(n,e);if(i==null)return r;const s=af(n);if(s!=null){const o=e.data.field(s.fieldPath);if(Da(o))for(const l of o.arrayValue.values||[])r=r.add(new Xr(n.indexId,e.key,this.Nn(l),i))}else r=r.add(new Xr(n.indexId,e.key,bl,i));return r}zn(e,n,r,i,s){F(J_,"Updating index entries for document '%s'",n.key);const o=[];return function(u,c,f,p,m){const w=u.getIterator(),R=c.getIterator();let C=Fi(w),O=Fi(R);for(;C||O;){let T=!1,v=!1;if(C&&O){const A=f(C,O);A<0?v=!0:A>0&&(T=!0)}else C!=null?v=!0:T=!0;T?(p(O),O=Fi(R)):v?(m(C),C=Fi(w)):(C=Fi(w),O=Fi(R))}}(i,s,Qn,l=>{o.push(this.jn(e,n,r,l))},l=>{o.push(this.Hn(e,n,r,l))}),k.waitFor(o)}Wn(e){let n=1;return ji(e).ee({index:oT,reverse:!0,range:IDBKeyRange.upperBound([this.uid,Number.MAX_SAFE_INTEGER])},(r,i,s)=>{s.done(),n=i.sequenceNumber+1}).next(()=>n)}createRange(e,n,r){r=r.sort((o,l)=>Qn(o,l)).filter((o,l,u)=>!l||Qn(o,u[l-1])!==0);const i=[];i.push(e);for(const o of r){const l=Qn(o,e),u=Qn(o,n);if(l===0)i[0]=e.En();else if(l>0&&u<0)i.push(o),i.push(o.En());else if(u>0)break}i.push(n);const s=[];for(let o=0;o<i.length;o+=2){if(this.Jn(i[o],i[o+1]))return[];const l=i[o].An(this.uid,bl,$.empty()),u=i[o+1].An(this.uid,bl,$.empty());s.push(IDBKeyRange.bound(l,u))}return s}Jn(e,n){return Qn(e,n)>0}getMinOffsetFromCollectionGroup(e,n){return this.getFieldIndexes(e,n).next(ev)}getMinOffset(e,n){return k.mapArray(this.vn(n),r=>this.Fn(e,r).next(i=>i||G(44426))).next(ev)}}function Z_(t){return ze(t,Ca)}function Bi(t){return ze(t,Zo)}function Ao(t){return ze(t,qp)}function ji(t){return ze(t,Jo)}function ev(t){K(t.length!==0,28825);let e=t[0].indexState.offset,n=e.largestBatchId;for(let r=1;r<t.length;r++){const i=t[r].indexState.offset;jp(i,e)<0&&(e=i),n<i.largestBatchId&&(n=i.largestBatchId)}return new xt(e.readTime,e.documentKey,n)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function d0(t,e,n){const r=t.store(Kt),i=t.store(Cs),s=[],o=IDBKeyRange.only(n.batchId);let l=0;const u=r.ee({range:o},(f,p,m)=>(l++,m.delete()));s.push(u.next(()=>{K(l===1,47070,{batchId:n.batchId})}));const c=[];for(const f of n.mutations){const p=rT(e,f.key.path,n.batchId);s.push(i.delete(p)),c.push(f.key)}return k.waitFor(s).next(()=>c)}function nc(t){if(!t)return 0;let e;if(t.document)e=t.document;else if(t.unknownDocument)e=t.unknownDocument;else{if(!t.noDocument)throw G(14731);e=t.noDocument}return JSON.stringify(e).length}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rv="LruGarbageCollector",UN=1048576;function iv([t,e],[n,r]){const i=X(t,n);return i===0?X(e,r):i}class BN{constructor(e){this.Pr=e,this.buffer=new fe(iv),this.Tr=0}Ir(){return++this.Tr}Er(e){const n=[e,this.Ir()];if(this.buffer.size<this.Pr)this.buffer=this.buffer.add(n);else{const r=this.buffer.last();iv(n,r)<0&&(this.buffer=this.buffer.delete(r).add(n))}}get maxValue(){return this.buffer.last()[0]}}class m0{constructor(e,n,r){this.garbageCollector=e,this.asyncQueue=n,this.localStore=r,this.Rr=null}start(){this.garbageCollector.params.cacheSizeCollectionThreshold!==-1&&this.Ar(6e4)}stop(){this.Rr&&(this.Rr.cancel(),this.Rr=null)}get started(){return this.Rr!==null}Ar(e){F(rv,`Garbage collection scheduled in ${e}ms`),this.Rr=this.asyncQueue.enqueueAfterDelay("lru_garbage_collection",e,async()=>{this.Rr=null;try{await this.localStore.collectGarbage(this.garbageCollector)}catch(n){Vr(n)?F(rv,"Ignoring IndexedDB error during garbage collection: ",n):await xi(n)}await this.Ar(3e5)})}}class jN{constructor(e,n){this.Vr=e,this.params=n}calculateTargetCount(e,n){return this.Vr.dr(e).next(r=>Math.floor(n/100*r))}nthSequenceNumber(e,n){if(n===0)return k.resolve(Ft.ce);const r=new BN(n);return this.Vr.forEachTarget(e,i=>r.Er(i.sequenceNumber)).next(()=>this.Vr.mr(e,i=>r.Er(i))).next(()=>r.maxValue)}removeTargets(e,n,r){return this.Vr.removeTargets(e,n,r)}removeOrphanedDocuments(e,n){return this.Vr.removeOrphanedDocuments(e,n)}collect(e,n){return this.params.cacheSizeCollectionThreshold===-1?(F("LruGarbageCollector","Garbage collection skipped; disabled"),k.resolve(tv)):this.getCacheSize(e).next(r=>r<this.params.cacheSizeCollectionThreshold?(F("LruGarbageCollector",`Garbage collection skipped; Cache size ${r} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`),tv):this.gr(e,n))}getCacheSize(e){return this.Vr.getCacheSize(e)}gr(e,n){let r,i,s,o,l,u,c;const f=Date.now();return this.calculateTargetCount(e,this.params.percentileToCollect).next(p=>(p>this.params.maximumSequenceNumbersToCollect?(F("LruGarbageCollector",`Capping sequence numbers to collect down to the maximum of ${this.params.maximumSequenceNumbersToCollect} from ${p}`),i=this.params.maximumSequenceNumbersToCollect):i=p,o=Date.now(),this.nthSequenceNumber(e,i))).next(p=>(r=p,l=Date.now(),this.removeTargets(e,r,n))).next(p=>(s=p,u=Date.now(),this.removeOrphanedDocuments(e,r))).next(p=>(c=Date.now(),$i()<=re.DEBUG&&F("LruGarbageCollector",`LRU Garbage Collection
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class w0{constructor(){this.Rs=!1,this.As=!1,this.Vs=100,this.ds=function(){return rI()?8:nT(je())>0?6:4}()}initialize(e,n){this.fs=e,this.indexManager=n,this.Rs=!0}getDocumentsMatchingQuery(e,n,r,i){const s={result:null};return this.gs(e,n).next(o=>{s.result=o}).next(()=>{if(!s.result)return this.ps(e,n,i,r).next(o=>{s.result=o})}).next(()=>{if(s.result)return;const o=new rD;return this.ys(e,n,o).next(l=>{if(s.result=l,this.As)return this.ws(e,n,o,l.size)})}).next(()=>s.result)}ws(e,n,r,i){return r.documentReadCount<this.Vs?($i()<=re.DEBUG&&F("QueryEngine","SDK will not create cache indexes for query:",qi(n),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),k.resolve()):($i()<=re.DEBUG&&F("QueryEngine","Query:",qi(n),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.ds*i?($i()<=re.DEBUG&&F("QueryEngine","The SDK decides to create cache indexes for query:",qi(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Bt(n))):k.resolve())}gs(e,n){if(D_(n))return k.resolve(null);let r=Bt(n);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=_f(n,null,"F"),r=Bt(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const o=te(...s);return this.fs.getDocuments(e,o).next(l=>this.indexManager.getMinOffset(e,r).next(u=>{const c=this.bs(n,l);return this.Ss(n,c,o,u.readTime)?this.gs(e,_f(n,null,"F")):this.Ds(e,c,n,u)}))})))}ps(e,n,r,i){return D_(n)||i.isEqual(W.min())?k.resolve(null):this.fs.getDocuments(e,r).next(s=>{const o=this.bs(n,s);return this.Ss(n,o,r,i)?k.resolve(null):($i()<=re.DEBUG&&F("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),qi(n)),this.Ds(e,o,n,tx(i,Ta)).next(l=>l))})}bs(e,n){let r=new fe(DT(e));return n.forEach((i,s)=>{Qa(e,s)&&(r=r.add(s))}),r}Ss(e,n,r,i){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const s=e.limitType==="F"?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}ys(e,n,r){return $i()<=re.DEBUG&&F("QueryEngine","Using full collection scan to execute query:",qi(n)),this.fs.getDocumentsMatchingQuery(e,n,xt.min(),r)}Ds(e,n,r,i){return this.fs.getDocumentsMatchingQuery(e,r,i).next(s=>(n.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hv="ConnectivityMonitor";class dv{constructor(){this.xo=()=>this.Oo(),this.No=()=>this.Bo(),this.Lo=[],this.ko()}Mo(e){this.Lo.push(e)}shutdown(){window.removeEventListener("online",this.xo),window.removeEventListener("offline",this.No)}ko(){window.addEventListener("online",this.xo),window.addEventListener("offline",this.No)}Oo(){F(hv,"Network connectivity changed: AVAILABLE");for(const e of this.Lo)e(0)}Bo(){F(hv,"Network connectivity changed: UNAVAILABLE");for(const e of this.Lo)e(1)}static v(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nt="WebChannelConnection",Co=(t,e,n)=>{t.listen(e,r=>{try{n(r)}catch(i){setTimeout(()=>{throw i},0)}})};class ms extends pD{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!ms.c_){const e=GI();Co(e,HI.STAT_EVENT,n=>{n.stat===sf.PROXY?F(nt,"STAT_EVENT: detected buffering proxy"):n.stat===sf.NOPROXY&&F(nt,"STAT_EVENT: detected no buffering proxy")}),ms.c_=!0}}zo(e,n,r,i,s){const o=Rf();return new Promise((l,u)=>{const c=new $I;c.setWithCredentials(!0),c.listenOnce(qI.COMPLETE,()=>{try{switch(c.getLastErrorCode()){case tu.NO_ERROR:const p=c.getResponseJson();F(nt,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(p)),l(p);break;case tu.TIMEOUT:F(nt,`RPC '${e}' ${o} timed out`),u(new z(b.DEADLINE_EXCEEDED,"Request time out"));break;case tu.HTTP_ERROR:const m=c.getStatus();if(F(nt,`RPC '${e}' ${o} failed with status:`,m,"response text:",c.getResponseText()),m>0){let w=c.getResponseJson();Array.isArray(w)&&(w=w[0]);const R=w==null?void 0:w.error;if(R&&R.status&&R.message){const C=function(T){const v=T.toLowerCase().replace(/_/g,"-");return Object.values(b).indexOf(v)>=0?v:b.UNKNOWN}(R.status);u(new z(C,R.message))}else u(new z(b.UNKNOWN,"Server responded with status "+c.getStatus()))}else u(new z(b.UNAVAILABLE,"Connection failed."));break;default:G(9055,{l_:e,streamId:o,h_:c.getLastErrorCode(),P_:c.getLastError()})}}finally{F(nt,`RPC '${e}' ${o} completed.`)}});const f=JSON.stringify(i);F(nt,`RPC '${e}' ${o} sending request:`,i),c.send(n,"POST",f,r,15)})}T_(e,n,r){const i=Rf(),s=[this.qo,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=this.createWebChannelTransport(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;u!==void 0&&(l.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(l.useFetchStreams=!0),this.Go(l.initMessageHeaders,n,r),l.encodeInitMessageHeaders=!0;const c=s.join("");F(nt,`Creating RPC '${e}' stream ${i}: ${c}`,l);const f=o.createWebChannel(c,l);this.I_(f);let p=!1,m=!1;const w=new mD({Ho:R=>{m?F(nt,`Not sending because RPC '${e}' stream ${i} is closed:`,R):(p||(F(nt,`Opening RPC '${e}' stream ${i} transport.`),f.open(),p=!0),F(nt,`RPC '${e}' stream ${i} sending:`,R),f.send(R))},Jo:()=>f.close()});return Co(f,Vo.EventType.OPEN,()=>{m||(F(nt,`RPC '${e}' stream ${i} transport opened.`),w.i_())}),Co(f,Vo.EventType.CLOSE,()=>{m||(m=!0,F(nt,`RPC '${e}' stream ${i} transport closed`),w.o_(),this.E_(f))}),Co(f,Vo.EventType.ERROR,R=>{m||(m=!0,vi(nt,`RPC '${e}' stream ${i} transport errored. Name:`,R.name,"Message:",R.message),w.o_(new z(b.UNAVAILABLE,"The operation could not be completed")))}),Co(f,Vo.EventType.MESSAGE,R=>{var C;if(!m){const O=R.data[0];K(!!O,16349);const T=O,v=(T==null?void 0:T.error)||((C=T[0])==null?void 0:C.error);if(v){F(nt,`RPC '${e}' stream ${i} received error:`,v);const A=v.status;let V=function(_){const y=Ve[_];if(y!==void 0)return HT(y)}(A),M=v.message;V===void 0&&(V=b.INTERNAL,M="Unknown error status: "+A+" with message "+v.message),m=!0,w.o_(new z(V,M)),f.close()}else F(nt,`RPC '${e}' stream ${i} received:`,O),w.__(O)}}),ms.u_(),setTimeout(()=>{w.s_()},0),w}terminate(){this.a_.forEach(e=>e.close()),this.a_=[]}I_(e){this.a_.push(e)}E_(e){this.a_=this.a_.filter(n=>n===e)}Go(e,n,r){super.Go(e,n,r),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return KI()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.aa?(ht(n),this.aa=!1):F("OnlineStateTracker",n)}Pa(){this._a!==null&&(this._a.cancel(),this._a=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mt{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Mt(Le.fromBase64String(e))}catch(n){throw new z(b.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+n)}}static fromUint8Array(e){return new Mt(Le.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}toJSON(){return{type:Mt._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(e){if(Ga(e,Mt._jsonSchema))return Mt.fromBase64String(e.bytes)}}Mt._jsonSchemaVersion="firestore/bytes/1.0",Mt._jsonSchema={type:Oe("string",Mt._jsonSchemaVersion),bytes:Oe("string")};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vm{constructor(...e){for(let n=0;n<e.length;++n)if(e[n].length===0)throw new z(b.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Se(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pn{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new z(b.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new z(b.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return X(this._lat,e._lat)||X(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:pn._jsonSchemaVersion}}static fromJSON(e){if(Ga(e,pn._jsonSchema))return new pn(e.latitude,e.longitude)}}pn._jsonSchemaVersion="firestore/geoPoint/1.0",pn._jsonSchema={type:Oe("string",pn._jsonSchemaVersion),latitude:Oe("number"),longitude:Oe("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class en{constructor(e){this._values=(e||[]).map(n=>n)}toArray(){return this._values.map(e=>e)}isEqual(e){return function(r,i){if(r.length!==i.length)return!1;for(let s=0;s<r.length;++s)if(r[s]!==i[s])return!1;return!0}(this._values,e._values)}toJSON(){return{type:en._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(Ga(e,en._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every(n=>typeof n=="number"))return new en(e.vectorValues);throw new z(b.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}en._jsonSchemaVersion="firestore/vectorValue/1.0",en._jsonSchema={type:Oe("string",en._jsonSchemaVersion),vectorValues:Oe("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */ys._jsonSchemaVersion="firestore/querySnapshot/1.0",ys._jsonSchema={type:Oe("string",ys._jsonSchemaVersion),bundleSource:Oe("string","QuerySnapshot"),bundleName:Oe("string"),bundle:Oe("string")};function OV(t,e,n,...r){t=Rn(t,Me);const i=Rn(t.firestore,Pi),s=Em(i);let o;return o=typeof(e=Ke(e))=="string"||e instanceof vm?SV(s,"updateDoc",t._key,e,n,r):TV(s,"updateDoc",t._key,e),Rm(i,[o.toMutation(t._key,dt.exists(!0))])}function MV(t){return Rm(Rn(t.firestore,Pi),[new Uc(t._key,dt.none())])}function LV(t,e){const n=Rn(t.firestore,Pi),r=xf(t),i=VV(t.converter,e),s=Em(t.firestore);return Rm(n,[IV(s,"addDoc",r._key,i,t.converter!==null,{}).toMutation(r._key,dt.exists(!1))]).then(()=>r)}function FV(t,...e){var c,f,p;t=Ke(t);let n={includeMetadataChanges:!1,source:"default"},r=0;typeof e[r]!="object"||Dv(e[r])||(n=e[r++]);const i={includeMetadataChanges:n.includeMetadataChanges,source:n.source};if(Dv(e[r])){const m=e[r];e[r]=(c=m.next)==null?void 0:c.bind(m),e[r+1]=(f=m.error)==null?void 0:f.bind(m),e[r+2]=(p=m.complete)==null?void 0:p.bind(m)}let s,o,l;if(t instanceof Me)o=Rn(t.firestore,Pi),l=Oc(t._key.path),s={next:m=>{e[r]&&e[r](UV(o,t,m))},error:e[r+1],complete:e[r+2]};else{const m=Rn(t,Di);o=Rn(m.firestore,Pi),l=m._query;const w=new Z0(o);s={next:R=>{e[r]&&e[r](new ys(o,w,m,R))},error:e[r+1],complete:e[r+2]},kV(t._query)}const u=H0(o);return hV(u,l,i,s)}function Rm(t,e){const n=H0(t);return dV(n,e)}function UV(t,e,n){const r=n.docs.get(e._key),i=new Z0(t);return new ui(t,i,e._key,r,new Lo(n.hasPendingWrites,n.fromCache),e.converter)}(function(e,n=!0){$k(Hs),As(new gi("firestore",(r,{instanceIdentifier:i,options:s})=>{const o=r.getProvider("app").getImmediate(),l=new Pi(new Gk(r.getProvider("auth-internal")),new Qk(o,r.getProvider("app-check-internal")),Ox(o,i),o);return s={useFetchStreams:n,...s},l._setSettings(s),l},"PUBLIC").setMultipleInstances(!0)),vr(xv,Nv,e),vr(xv,Nv,"esm2020")})();const BV={apiKey:"AIzaSyBSFq7YkTgMA4gr1AfBxWXbWoBn7JLozQw",authDomain:"guiter-code-ad4df.firebaseapp.com",projectId:"guiter-code-ad4df",storageBucket:"guiter-code-ad4df.firebasestorage.app",messagingSenderId:"474318515571",appId:"1:474318515571:web:8b128de0df7a71eef42906",measurementId:"G-6DGZLTRB7M"},rS=lI(BV),Nf=jk(rS),jV=new wn,Fo=gV(rS);try{yV(Fo).catch(t=>{t.code==="failed-precondition"?console.warn("Firestore persistence failed: Multiple tabs open"):t.code==="unimplemented"&&console.warn("Firestore persistence failed: Browser not supported")})}catch(t){console.error("Persistence setup error:",t)}const Fl="guitar_scroll_songs";function zV(t){const[e,n]=ae.useState([]),[r,i]=ae.useState(null),[s,o]=ae.useState(!0);ae.useEffect(()=>{console.log("[Sync Status]",t?`Logged in as ${t.email}`:"Guest Mode")},[t]),ae.useEffect(()=>{if(!t){const p=localStorage.getItem(Fl);n(p?JSON.parse(p):[]),o(!1)}},[t]),ae.useEffect(()=>{if(!t)return;o(!0),console.log("[Firestore] Starting listener for user:",t.uid);const p=xV(Av(Fo,"songs"),NV("userId","==",t.uid),DV("createdAt","desc")),m=FV(p,w=>{const R=w.docs.map(C=>{var T;const O=C.data();return{id:C.id,...O,createdAt:(T=O.createdAt)!=null&&T.toMillis?O.createdAt.toMillis():Date.now()}});console.log(`[Firestore] Sync complete. ${R.length} songs found.`),n(R),o(!1)},w=>{console.error("[Firestore] Sync error:",w),o(!1)});return()=>m()},[t]);const l=ae.useCallback(async p=>{const m={title:"名称未設定の曲",artist:"",bpm:120,imageUrl:"",scrollSpeed:20,...p};if(t){console.log("[Firestore] Adding song...");try{const w=await LV(Av(Fo,"songs"),{...m,userId:t.uid,createdAt:kv()});return console.log("[Firestore] Song added with ID:",w.id),{id:w.id,...m}}catch(w){throw console.error("[Firestore] Add error:",w),w}}else{const w={id:crypto.randomUUID(),...m,createdAt:Date.now()},R=[w,...e];return n(R),localStorage.setItem(Fl,JSON.stringify(R)),w}},[t,e]),u=ae.useCallback(async(p,m)=>{if(t){console.log("[Firestore] Updating song:",p);try{const w=xf(Fo,"songs",p);await OV(w,{...m,updatedAt:kv()})}catch(w){throw console.error("[Firestore] Update error:",w),w}}else{const w=e.map(R=>R.id===p?{...R,...m}:R);n(w),localStorage.setItem(Fl,JSON.stringify(w))}},[t,e]),c=ae.useCallback(async p=>{if(t){console.log("[Firestore] Deleting song:",p);try{await MV(xf(Fo,"songs",p))}catch(m){throw console.error("[Firestore] Delete error:",m),m}}else{const m=e.filter(w=>w.id!==p);n(m),localStorage.setItem(Fl,JSON.stringify(m))}r===p&&i(null)},[t,e,r]),f=e.find(p=>p.id===r)||null;return{songs:e,currentSong:f,currentSongId:r,setCurrentSongId:i,addSong:l,updateSong:u,deleteSong:c,loading:s}}function $V({songs:t,currentSongId:e,onSelect:n,onAdd:r}){return B.jsxs("div",{className:"song-list-container",children:[t.length===0?B.jsx("div",{className:"empty-msg",children:"楽曲が登録されていません"}):B.jsx("ul",{className:"list-items",children:t.map(i=>B.jsxs("li",{className:`song-item ${i.id===e?"active":""}`,onClick:()=>n(i.id),children:[B.jsx("div",{className:"song-title",children:i.title}),B.jsxs("div",{className:"song-meta",children:[i.artist||"Unknown"," / BPM: ",i.bpm]})]},i.id))}),B.jsx("style",{jsx:!0,children:`
      ...
      `})]})}function GV({song:t,isPlaying:e,scrollSpeed:n,scrollPos:r,onScrollUpdate:i}){const s=ae.useRef(null),{imageUrl:o}=t;return ae.useEffect(()=>{let l,u=performance.now();const c=f=>{if(e){const p=(f-u)/1e3,m=n*p;i(w=>w+m)}u=f,l=requestAnimationFrame(c)};return l=requestAnimationFrame(c),()=>cancelAnimationFrame(l)},[e,n,i]),ae.useEffect(()=>{s.current&&(s.current.scrollTop=r)},[r]),B.jsxs("div",{className:"chord-viewer",ref:s,children:[B.jsx("div",{className:"chord-content-wrapper",children:o?B.jsx("img",{src:o,alt:"Sheet Music",className:"sheet-image"}):B.jsx("div",{className:"no-image-msg",children:"楽譜画像がありません"})}),B.jsx("style",{jsx:!0,children:`
        .chord-viewer {
          width: 100%;
          height: 100%;
          overflow-y: auto;
      ...
      `})]})}const QV=400;function YV(){const[t,e]=ae.useState(null),[n,r]=ae.useState(window.innerWidth<768),[i,s]=ae.useState(!0),o=ae.useRef(null);ae.useEffect(()=>{const se=kC(Nf,Re=>{e(Re)});return()=>se()},[]);const{songs:l,currentSong:u,currentSongId:c,setCurrentSongId:f,addSong:p,updateSong:m,deleteSong:w,loading:R}=zV(t),[C,O]=ae.useState(!1),[T,v]=ae.useState(!1),[A,V]=ae.useState(0),[M,L]=ae.useState(20),_=ae.useCallback(()=>{s(!0),o.current&&clearTimeout(o.current),T&&(o.current=setTimeout(()=>{s(!1)},3e3))},[T]);ae.useEffect(()=>(_(),()=>{o.current&&clearTimeout(o.current)}),[T,_]);const y=ae.useCallback(()=>{v(se=>!se)},[]),E=ae.useCallback(()=>{v(!1),V(0)},[]);ae.useEffect(()=>{const se=Re=>{Re.code==="Space"&&!C&&(Re.preventDefault(),y()),Re.code==="KeyS"&&!C&&r(yn=>!yn)};return window.addEventListener("keydown",se),()=>window.removeEventListener("keydown",se)},[y,C]);const S=ae.useCallback(()=>{if(u!=null&&u.bpm){const se=u.bpm/60/4*QV;L(Math.round(se))}},[u]),P=se=>{f(se),O(!1),E();const Re=l.find(yn=>yn.id===se);Re!=null&&Re.scrollSpeed&&L(Re.scrollSpeed)},x=async se=>{if(c)await m(c,{...se,scrollSpeed:M});else{const Re=await p({...se,scrollSpeed:M});f(Re.id)}O(!1)},I=async se=>{window.confirm("この曲を削除してもよろしいですか？")&&(await w(se),O(!1))};return B.jsxs("div",{className:`app-container ${n?"sidebar-collapsed":""}`,onClick:_,onTouchStart:_,children:[B.jsxs("nav",{className:"sidebar",children:[B.jsxs("div",{className:"sidebar-header",children:[B.jsx("h1",{children:"Guitar Scroll"}),B.jsx("button",{className:"toggle-btn",onClick:()=>r(!0),children:"◀"})]}),B.jsx(WV,{user:t}),B.jsx($V,{songs:l,currentSongId:c,onSelect:P}),B.jsx("div",{className:"sidebar-footer",children:B.jsx("button",{className:"add-button",onClick:()=>{f(null),O(!0)},children:"＋ 新しい曲"})})]}),n&&B.jsx("button",{className:"expand-btn",onClick:()=>r(!1),children:"▶"}),B.jsxs("main",{className:"main-content",children:[B.jsxs("header",{className:`app-header ${!i&&T?"header-hidden":""}`,children:[B.jsx("div",{className:"song-info",children:u?B.jsxs(B.Fragment,{children:[B.jsx("h2",{children:u.title}),B.jsxs("span",{className:"metadata",children:[u.artist," | BPM: ",u.bpm]})]}):B.jsx("h2",{children:R?"読み込み中...":"曲を選択してください"})}),B.jsx("div",{className:"app-actions",children:u&&B.jsx("button",{className:"edit-toggle",onClick:()=>O(!C),children:C?"完了":"編集"})})]}),B.jsx("section",{className:"viewer-area",children:C?B.jsx(HV,{song:u,onSave:x,onCancel:()=>O(!1),onDelete:I}):u?B.jsx(GV,{song:u,isPlaying:T,scrollSpeed:M,scrollPos:A,onScrollUpdate:V}):B.jsx("div",{className:"placeholder-msg",children:B.jsx("p",{children:"曲を選択するか「＋ 新しい曲」から楽譜画像を追加してください。"})})}),u&&!C&&B.jsx("footer",{className:`controls-area floating-panel ${!i&&T?"controls-hidden":""}`,children:B.jsxs("div",{className:"floating-inner",children:[B.jsx("div",{className:"bpm-sync-panel",children:B.jsx("button",{className:"sync-btn",onClick:S,children:"BPM同期"})}),B.jsx(KV,{isPlaying:T,onTogglePlay:y,onReset:E,scrollSpeed:M,onSpeedChange:L})]})})]}),B.jsx("style",{jsx:!0,children:`
        .app-container {
          display: flex;
          height: 100vh;
          height: 100dvh;
