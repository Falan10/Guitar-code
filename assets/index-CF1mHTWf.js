...
Total Duration: ${c-f}ms`),k.resolve({didRun:!0,sequenceNumbersCollected:i,targetsRemoved:s,documentsRemoved:p})))}}function g0(t,e){return new BN(t,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class w0{constructor(){this.Rs=!1,this.As=!1,this.Vs=100,this.ds=function(){return rI()?8:nT(Be())>0?6:4}()}initialize(e,n){this.fs=e,this.indexManager=n,this.Rs=!0}getDocumentsMatchingQuery(e,n,r,i){const s={result:null};return this.gs(e,n).next(o=>{s.result=o}).next(()=>{if(!s.result)return this.ps(e,n,i,r).next(o=>{s.result=o})}).next(()=>{if(s.result)return;const o=new rD;return this.ys(e,n,o).next(l=>{if(s.result=l,this.As)return this.ws(e,n,o,l.size)})}).next(()=>s.result)}ws(e,n,r,i){return r.documentReadCount<this.Vs?($i()<=re.DEBUG&&F("QueryEngine","SDK will not create cache indexes for query:",qi(n),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),k.resolve()):($i()<=re.DEBUG&&F("QueryEngine","Query:",qi(n),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.ds*i?($i()<=re.DEBUG&&F("QueryEngine","The SDK decides to create cache indexes for query:",qi(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,jt(n))):k.resolve())}gs(e,n){if(D_(n))return k.resolve(null);let r=jt(n);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=_f(n,null,"F"),r=jt(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const o=te(...s);return this.fs.getDocuments(e,o).next(l=>this.indexManager.getMinOffset(e,r).next(u=>{const c=this.bs(n,l);return this.Ss(n,c,o,u.readTime)?this.gs(e,_f(n,null,"F")):this.Ds(e,c,n,u)}))})))}ps(e,n,r,i){return D_(n)||i.isEqual(W.min())?k.resolve(null):this.fs.getDocuments(e,r).next(s=>{const o=this.bs(n,s);return this.Ss(n,o,r,i)?k.resolve(null):($i()<=re.DEBUG&&F("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),qi(n)),this.Ds(e,o,n,tx(i,Ta)).next(l=>l))})}bs(e,n){let r=new fe(DT(e));return n.forEach((i,s)=>{Qa(e,s)&&(r=r.add(s))}),r}Ss(e,n,r,i){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const s=e.limitType==="F"?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}ys(e,n,r){return $i()<=re.DEBUG&&F("QueryEngine","Using full collection scan to execute query:",qi(n)),this.fs.getDocumentsMatchingQuery(e,n,xt.min(),r)}Ds(e,n,r,i){return this.fs.getDocumentsMatchingQuery(e,r,i).next(s=>(n.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */ys._jsonSchemaVersion="firestore/querySnapshot/1.0",ys._jsonSchema={type:Oe("string",ys._jsonSchemaVersion),bundleSource:Oe("string","QuerySnapshot"),bundleName:Oe("string"),bundle:Oe("string")};function OV(t,e,n,...r){t=Rn(t,Me);const i=Rn(t.firestore,Pi),s=Em(i);let o;return o=typeof(e=Ke(e))=="string"||e instanceof vm?SV(s,"updateDoc",t._key,e,n,r):TV(s,"updateDoc",t._key,e),Rm(i,[o.toMutation(t._key,dt.exists(!0))])}function MV(t){return Rm(Rn(t.firestore,Pi),[new Uc(t._key,dt.none())])}function LV(t,e){const n=Rn(t.firestore,Pi),r=xf(t),i=VV(t.converter,e),s=Em(t.firestore);return Rm(n,[IV(s,"addDoc",r._key,i,t.converter!==null,{}).toMutation(r._key,dt.exists(!1))]).then(()=>r)}function FV(t,...e){var c,f,p;t=Ke(t);let n={includeMetadataChanges:!1,source:"default"},r=0;typeof e[r]!="object"||Dv(e[r])||(n=e[r++]);const i={includeMetadataChanges:n.includeMetadataChanges,source:n.source};if(Dv(e[r])){const m=e[r];e[r]=(c=m.next)==null?void 0:c.bind(m),e[r+1]=(f=m.error)==null?void 0:f.bind(m),e[r+2]=(p=m.complete)==null?void 0:p.bind(m)}let s,o,l;if(t instanceof Me)o=Rn(t.firestore,Pi),l=Oc(t._key.path),s={next:m=>{e[r]&&e[r](UV(o,t,m))},error:e[r+1],complete:e[r+2]};else{const m=Rn(t,Di);o=Rn(m.firestore,Pi),l=m._query;const w=new Z0(o);s={next:R=>{e[r]&&e[r](new ys(o,w,m,R))},error:e[r+1],complete:e[r+2]},kV(t._query)}const u=H0(o);return hV(u,l,i,s)}function Rm(t,e){const n=H0(t);return dV(n,e)}function UV(t,e,n){const r=n.docs.get(e._key),i=new Z0(t);return new ui(t,i,e._key,r,new Lo(n.hasPendingWrites,n.fromCache),e.converter)}(function(e,n=!0){$k(Hs),As(new gi("firestore",(r,{instanceIdentifier:i,options:s})=>{const o=r.getProvider("app").getImmediate(),l=new Pi(new Gk(r.getProvider("auth-internal")),new Qk(o,r.getProvider("app-check-internal")),Ox(o,i),o);return s={useFetchStreams:n,...s},l._setSettings(s),l},"PUBLIC").setMultipleInstances(!0)),vr(xv,Nv,e),vr(xv,Nv,"esm2020")})();const jV={apiKey:"AIzaSyBSFq7YkTgMA4gr1AfBxWXbWoBn7JLozQw",authDomain:"guiter-code-ad4df.firebaseapp.com",projectId:"guiter-code-ad4df",storageBucket:"guiter-code-ad4df.firebasestorage.app",messagingSenderId:"474318515571",appId:"1:474318515571:web:8b128de0df7a71eef42906",measurementId:"G-6DGZLTRB7M"},rS=lI(jV),Nf=Bk(rS),BV=new wn,Fo=gV(rS);try{yV(Fo).catch(t=>{t.code==="failed-precondition"?console.warn("Firestore persistence failed: Multiple tabs open"):t.code==="unimplemented"&&console.warn("Firestore persistence failed: Browser not supported")})}catch(t){console.error("Persistence setup error:",t)}const Fl="guitar_scroll_songs";function zV(t){const[e,n]=ae.useState([]),[r,i]=ae.useState(null),[s,o]=ae.useState(!0);ae.useEffect(()=>{console.log("[Sync Status]",t?`Logged in as ${t.email}`:"Guest Mode")},[t]),ae.useEffect(()=>{if(!t){const p=localStorage.getItem(Fl);n(p?JSON.parse(p):[]),o(!1)}},[t]),ae.useEffect(()=>{if(!t)return;o(!0),console.log("[Firestore] Starting listener for user:",t.uid);const p=xV(Av(Fo,"songs"),NV("userId","==",t.uid),DV("createdAt","desc")),m=FV(p,w=>{const R=w.docs.map(C=>{var T;const O=C.data();return{id:C.id,...O,createdAt:(T=O.createdAt)!=null&&T.toMillis?O.createdAt.toMillis():Date.now()}});console.log(`[Firestore] Sync complete. ${R.length} songs found.`),n(R),o(!1)},w=>{console.error("[Firestore] Sync error:",w),o(!1)});return()=>m()},[t]);const l=ae.useCallback(async p=>{const m={title:"名称未設定の曲",artist:"",bpm:120,imageUrl:"",scrollSpeed:20,...p};if(t){console.log("[Firestore] Adding song...");try{const w=await LV(Av(Fo,"songs"),{...m,userId:t.uid,createdAt:kv()});return console.log("[Firestore] Song added with ID:",w.id),{id:w.id,...m}}catch(w){throw console.error("[Firestore] Add error:",w),w}}else{const w={id:crypto.randomUUID(),...m,createdAt:Date.now()},R=[w,...e];return n(R),localStorage.setItem(Fl,JSON.stringify(R)),w}},[t,e]),u=ae.useCallback(async(p,m)=>{if(t){console.log("[Firestore] Updating song:",p);try{const w=xf(Fo,"songs",p);await OV(w,{...m,updatedAt:kv()})}catch(w){throw console.error("[Firestore] Update error:",w),w}}else{const w=e.map(R=>R.id===p?{...R,...m}:R);n(w),localStorage.setItem(Fl,JSON.stringify(w))}},[t,e]),c=ae.useCallback(async p=>{if(t){console.log("[Firestore] Deleting song:",p);try{await MV(xf(Fo,"songs",p))}catch(m){throw console.error("[Firestore] Delete error:",m),m}}else{const m=e.filter(w=>w.id!==p);n(m),localStorage.setItem(Fl,JSON.stringify(m))}r===p&&i(null)},[t,e,r]),f=e.find(p=>p.id===r)||null;return{songs:e,currentSong:f,currentSongId:r,setCurrentSongId:i,addSong:l,updateSong:u,deleteSong:c,loading:s}}function $V({songs:t,currentSongId:e,onSelect:n,onAdd:r}){return j.jsxs("div",{className:"song-list-container",children:[t.length===0?j.jsx("div",{className:"empty-msg",children:"楽曲が登録されていません"}):j.jsx("ul",{className:"list-items",children:t.map(i=>j.jsxs("li",{className:`song-item ${i.id===e?"active":""}`,onClick:()=>n(i.id),children:[j.jsx("div",{className:"song-title",children:i.title}),j.jsxs("div",{className:"song-meta",children:[i.artist||"Unknown"," / BPM: ",i.bpm]})]},i.id))}),j.jsx("style",{jsx:!0,children:`
      ...
      `})]})}const qV=(t,e=1200)=>new Promise((n,r)=>{const i=new FileReader;i.readAsDataURL(t),i.onload=s=>{const o=new Image;o.src=s.target.result,o.onload=()=>{const l=document.createElement("canvas");let u=o.width,c=o.height;u>e&&(c=Math.round(c*e/u),u=e),l.width=u,l.height=c,l.getContext("2d").drawImage(o,0,0,u,c),n(l.toDataURL("image/jpeg",.8))},o.onerror=r},i.onerror=r});function HV({song:t,onSave:e,onCancel:n,onDelete:r}){const[i,s]=ae.useState({title:(t==null?void 0:t.title)||"",artist:(t==null?void 0:t.artist)||"",bpm:(t==null?void 0:t.bpm)||120,imageUrl:(t==null?void 0:t.imageUrl)||""}),[o,l]=ae.useState(!1),u=ae.useRef(null),c=w=>{const{name:R,value:C}=w.target;s(O=>({...O,[R]:R==="bpm"?Number(C):C}))},f=async w=>{const R=w.target.files[0];if(R){l(!0);try{const C=await qV(R);s(O=>({...O,imageUrl:C}))}catch(C){alert("画像の処理に失敗しました"),console.error(C)}finally{l(!1)}}},p=()=>{s(w=>({...w,imageUrl:""}))},m=()=>{if(!i.title)return alert("曲名を入力してください");if(!i.imageUrl)return alert("楽譜画像をアップロードしてください");e(i)};return j.jsxs("div",{className:"song-editor",children:[j.jsxs("div",{className:"editor-header",children:[j.jsx("h3",{children:t?"曲を編集":"新しい曲を追加"}),t&&j.jsx("button",{className:"delete-link",onClick:()=>r(t.id),children:"削除"})]}),j.jsxs("div",{className:"form-group",children:[j.jsx("label",{children:"曲名"}),j.jsx("input",{name:"title",value:i.title,onChange:c,placeholder:"曲名を入力"})]}),j.jsxs("div",{className:"form-row",children:[j.jsxs("div",{className:"form-group flex-1",children:[j.jsx("label",{children:"アーティスト"}),j.jsx("input",{name:"artist",value:i.artist,onChange:c,placeholder:"アーティスト名"})]}),j.jsxs("div",{className:"form-group w-80",children:[j.jsx("label",{children:"BPM"}),j.jsx("input",{type:"number",name:"bpm",value:i.bpm,onChange:c})]})]}),j.jsxs("div",{className:"form-group image-upload-area",children:[j.jsx("label",{children:"楽譜画像 (必須)"}),i.imageUrl?j.jsxs("div",{className:"image-preview-container",children:[j.jsx("img",{src:i.imageUrl,alt:"preview",className:"img-preview"}),j.jsxs("div",{className:"image-actions",children:[j.jsx("button",{className:"btn-secondary",onClick:()=>u.current.click(),children:"変更"}),j.jsx("button",{className:"btn-danger",onClick:p,children:"削除"})]})]}):j.jsx("div",{className:"upload-placeholder",onClick:()=>u.current.click(),children:o?"処理中...":"クリックして楽譜画像またはスクリーンショットを選択"}),j.jsx("input",{type:"file",ref:u,onChange:f,accept:"image/*",style:{display:"none"}})]}),j.jsxs("div",{className:"editor-actions",children:[j.jsx("button",{className:"btn-cancel",onClick:n,children:"キャンセル"}),j.jsx("button",{className:"btn-save",onClick:m,children:"保存する"})]}),j.jsx("style",{jsx:!0,children:`
        .song-editor {
          width: 100%;
          max-width: 600px;
      ...
      `})]})}function KV({isPlaying:t,onTogglePlay:e,onReset:n,scrollSpeed:r,onSpeedChange:i}){return j.jsxs("div",{className:"control-panel",children:[j.jsxs("div",{className:"controls-group",children:[j.jsx("button",{className:"ctrl-btn secondary",onClick:n,title:"最初に戻る",children:"⏮"}),j.jsx("button",{className:`ctrl-btn main ${t?"playing":""}`,onClick:e,children:t?"⏸ PAUSE":"▶ PLAY"})]}),j.jsxs("div",{className:"speed-control",children:[j.jsxs("div",{className:"speed-label-row",children:[j.jsx("label",{children:"速度:"}),j.jsx("input",{type:"number",className:"speed-number-input",value:r,onChange:s=>i(Number(s.target.value)),min:"1",max:"1000"}),j.jsx("span",{className:"unit-label",children:"px/s"})]}),j.jsx("input",{type:"range",min:"1",max:"300",step:"1",value:r,onChange:s=>i(Number(s.target.value))})]}),j.jsx("style",{jsx:!0,children:`
        .control-panel {
          display: flex;
          align-items: center;
          gap: 3rem;
      ...
      `})]})}function WV({user:t}){const e=async()=>{try{await YC(Nf,BV)}catch(r){console.error("Login failed",r),alert("ログインに失敗しました。Firebase ConsoleでGoogle Authを有効にし、ドメインを承認しているか確認してください。")}},n=()=>{window.confirm("ログアウトしますか？")&&xC(Nf)};return j.jsxs("div",{className:"auth-area",children:[t?j.jsxs("div",{className:"user-profile",children:[j.jsx("img",{src:t.photoURL,alt:t.displayName,className:"user-avatar"}),j.jsxs("div",{className:"user-info",children:[j.jsx("span",{className:"user-name",children:t.displayName}),j.jsx("button",{className:"auth-btn logout",onClick:n,children:"ログアウト"})]})]}):j.jsx("button",{className:"auth-btn login",onClick:e,children:"Googleでログイン"}),j.jsx("style",{jsx:!0,children:`
        .auth-area {
          padding: 1rem;
      ...
      `})]})}const QV=400;function YV(){const[t,e]=ae.useState(null),[n,r]=ae.useState(window.innerWidth<768),[i,s]=ae.useState(!0),o=ae.useRef(null);ae.useEffect(()=>{const se=kC(Nf,Re=>{e(Re)});return()=>se()},[]);const{songs:l,currentSong:u,currentSongId:c,setCurrentSongId:f,addSong:p,updateSong:m,deleteSong:w,loading:R}=zV(t),[C,O]=ae.useState(!1),[T,v]=ae.useState(!1),[A,V]=ae.useState(0),[M,L]=ae.useState(20),_=ae.useCallback(()=>{s(!0),o.current&&clearTimeout(o.current),T&&(o.current=setTimeout(()=>{s(!1)},3e3))},[T]);ae.useEffect(()=>(_(),()=>{o.current&&clearTimeout(o.current)}),[T,_]);const y=ae.useCallback(()=>{v(se=>!se)},[]),E=ae.useCallback(()=>{v(!1),V(0)},[]);ae.useEffect(()=>{const se=Re=>{Re.code==="Space"&&!C&&(Re.preventDefault(),y()),Re.code==="KeyS"&&!C&&r(yn=>!yn)};return window.addEventListener("keydown",se),()=>window.removeEventListener("keydown",se)},[y,C]);const S=ae.useCallback(()=>{if(u!=null&&u.bpm){const se=u.bpm/60/4*QV;L(Math.round(se))}},[u]),P=se=>{f(se),O(!1),E();const Re=l.find(yn=>yn.id===se);Re!=null&&Re.scrollSpeed&&L(Re.scrollSpeed)},x=async se=>{if(c)await m(c,{...se,scrollSpeed:M});else{const Re=await p({...se,scrollSpeed:M});f(Re.id)}O(!1)},I=async se=>{window.confirm("この曲を削除してもよろしいですか？")&&(await w(se),O(!1))};return j.jsxs("div",{className:`app-container ${n?"sidebar-collapsed":""}`,onClick:_,onTouchStart:_,children:[j.jsxs("nav",{className:"sidebar",children:[j.jsxs("div",{className:"sidebar-header",children:[j.jsx("h1",{children:"Guitar Scroll"}),j.jsx("button",{className:"toggle-btn",onClick:()=>r(!0),children:"◀"})]}),j.jsx(WV,{user:t}),j.jsx($V,{songs:l,currentSongId:c,onSelect:P}),j.jsx("div",{className:"sidebar-footer",children:j.jsx("button",{className:"add-button",onClick:()=>{f(null),O(!0)},children:"＋ 新しい曲"})})]}),j.jsxs("main",{className:"main-content",children:[j.jsxs("header",{className:`app-header ${!i&&T?"header-hidden":""}`,children:[j.jsx("div",{className:"song-info",children:u?j.jsxs(j.Fragment,{children:[j.jsx("h2",{children:u.title}),j.jsxs("span",{className:"metadata",children:[u.artist," | BPM: ",u.bpm]})]}):j.jsx("h2",{children:R?"読み込み中...":"曲を選択してください"})}),j.jsx("div",{className:"app-actions",children:u&&j.jsx("button",{className:"edit-toggle",onClick:()=>O(!C),children:C?"完了":"編集"})})]}),j.jsx("section",{className:"viewer-area",children:C?j.jsx(HV,{song:u,onSave:x,onCancel:()=>O(!1),onDelete:I}):u?j.jsx(GV,{song:u,isPlaying:T,scrollSpeed:M,scrollPos:A,onScrollUpdate:V}):j.jsx("div",{className:"placeholder-msg",children:j.jsx("p",{children:"曲を選択するか「＋ 新しい曲」から楽譜画像を追加してください。"})})}),(u||n&&!C)&&j.jsx("footer",{className:`controls-area floating-panel ${!i&&T?"controls-hidden":""}`,children:j.jsxs("div",{className:"floating-inner",children:[j.jsxs("div",{className:"top-row",children:[n&&j.jsx("button",{className:"expand-btn-floating",onClick:()=>r(!1),children:"☰ 曲一覧"}),u&&j.jsx("div",{className:"bpm-sync-panel",children:j.jsx("button",{className:"sync-btn",onClick:S,children:"BPM同期"})})]}),u&&j.jsx(KV,{isPlaying:T,onTogglePlay:y,onReset:E,scrollSpeed:M,onSpeedChange:L})]})})]}),j.jsx("style",{jsx:!0,children:`
        .app-container {
          display: flex;
          height: 100vh;
          height: 100dvh;
      ...
      `})]})}rd.createRoot(document.getElementById("root")).render(j.jsx(QS.StrictMode,{children:j.jsx(YV,{})}));
