 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function g0(t){var n,r;if(K(t instanceof ie||t instanceof ce,20012),t instanceof ie){if(t instanceof MT){const i=((r=(n=t.value.arrayValue)==null?void 0:n.values)==null?void 0:r.map(s=>ie.create(t.field,"==",s)))||[];return ce.create(i,"or")}return t}const e=t.filters.map(i=>g0(i));return ce.create(e,t.op)}function QN(t){if(t.getFilters().length===0)return[];const e=Of(g0(t));return K(y0(e),7391),Vf(e)||bf(e)?[e]:e.getFilters()}function Vf(t){return t instanceof ie}function bf(t){return t instanceof ce&&om(t)}function y0(t){return Vf(t)||bf(t)||function(n){if(n instanceof ce&&Sf(n)){for(const r of n.getFilters())if(!Vf(r)&&!bf(r))return!1;return!0}return!1}(t)}function Of(t){if(K(t instanceof ie||t instanceof ce,34018),t instanceof ie)return t;if(t.filters.length===1)return Of(t.filters[0]);const e=t.filters.map(r=>Of(r));let n=ce.create(e,t.op);return n=sc(n),y0(n)?n:(K(n instanceof ce,64498),K(js(n),40251),K(n.filters.length>1,57927),n.filters.reduce((r,i)=>fm(r,i)))}function fm(t,e){let n;return K(t instanceof ie||t instanceof ce,38388),K(e instanceof ie||e instanceof ce,25473),n=t instanceof ie?e instanceof ie?function(i,s){return ce.create([i,s],"and")}(t,e):sv(t,e):e instanceof ie?sv(e,t):function(i,s){if(K(i.filters.length>0&&s.filters.length>0,48005),js(i)&&js(s))return VT(i,s.getFilters());const o=Sf(i)?i:s,l=Sf(i)?s:i,u=o.filters.map(c=>fm(c,l));return ce.create(u,"or")}(t,e),sc(n)}function sv(t,e){if(js(e))return VT(e,t.getFilters());{const n=e.filters.map(r=>fm(t,r));return ce.create(n,"or")}}function sc(t){if(K(t instanceof ie||t instanceof ce,11850),t instanceof ie)return t;const e=t.getFilters();if(e.length===1)return sc(e[0]);if(NT(t))return t;const n=e.map(i=>sc(i)),r=[];return n.forEach(i=>{i instanceof ie?r.push(i):i instanceof ce&&(i.op===t.op?r.push(...i.filters):r.push(i))}),r.length===1?r[0]:ce.create(r,t.op)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
