 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(q,Y){var Z=q.length;q.push(Y);e:for(;0<Z;){var we=Z-1>>>1,Ne=q[we];if(0<i(Ne,Y))q[we]=Y,q[Z]=Ne,Z=we;else break e}}function n(q){return q.length===0?null:q[0]}function r(q){if(q.length===0)return null;var Y=q[0],Z=q.pop();if(Z!==Y){q[0]=Z;e:for(var we=0,Ne=q.length,Ur=Ne>>>1;we<Ur;){var Mt=2*(we+1)-1,jr=q[Mt],Kt=Mt+1,qn=q[Kt];if(0>i(jr,Z))Kt<Ne&&0>i(qn,jr)?(q[we]=qn,q[Kt]=Z,we=Kt):(q[we]=jr,q[Mt]=Z,we=Mt);else if(Kt<Ne&&0>i(qn,Z))q[we]=qn,q[Kt]=Z,we=Kt;else break e}}return Y}function i(q,Y){var Z=q.sortIndex-Y.sortIndex;return Z!==0?Z:q.id-Y.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var u=[],c=[],f=1,p=null,m=3,T=!1,R=!1,C=!1,D=typeof setTimeout=="function"?setTimeout:null,w=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function E(q){for(var Y=n(c);Y!==null;){if(Y.callback===null)r(c);else if(Y.startTime<=q)r(c),Y.sortIndex=Y.expirationTime,e(u,Y);else break;Y=n(c)}}function V(q){if(C=!1,E(q),!R)if(n(u)!==null)R=!0,pe(O);else{var Y=n(c);Y!==null&&At(V,Y.startTime-q)}}function O(q,Y){R=!1,C&&(C=!1,w(g),g=-1),T=!0;var Z=m;try{for(E(Y),p=n(u);p!==null&&(!(p.expirationTime>Y)||q&&!P());){var we=p.callback;if(typeof we=="function"){p.callback=null,m=p.priorityLevel;var Ne=we(p.expirationTime<=Y);Y=t.unstable_now(),typeof Ne=="function"?p.callback=Ne:p===n(u)&&r(u),E(Y)}else r(u);p=n(u)}if(p!==null)var Ur=!0;else{var Mt=n(c);Mt!==null&&At(V,Mt.startTime-Y),Ur=!1}return Ur}finally{p=null,m=Z,T=!1}}var L=!1,v=null,g=-1,I=5,A=-1;function P(){return!(t.unstable_now()-A<I)}function x(){if(v!==null){var q=t.unstable_now();A=q;var Y=!0;try{Y=v(!0,q)}finally{Y?S():(L=!1,v=null)}}else L=!1}var S;if(typeof _=="function")S=function(){_(x)};else if(typeof MessageChannel<"u"){var Ue=new MessageChannel,fe=Ue.port2;Ue.port1.onmessage=x,S=function(){fe.postMessage(null)}}else S=function(){D(x,0)};function pe(q){v=q,L||(L=!0,S())}function At(q,Y){g=D(function(){q(t.unstable_now())},Y)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(q){q.callback=null},t.unstable_continueExecution=function(){R||T||(R=!0,pe(O))},t.unstable_forceFrameRate=function(q){0>q||125<q?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):I=0<q?Math.floor(1e3/q):5},t.unstable_getCurrentPriorityLevel=function(){return m},t.unstable_getFirstCallbackNode=function(){return n(u)},t.unstable_next=function(q){switch(m){case 1:case 2:case 3:var Y=3;break;default:Y=m}var Z=m;m=Y;try{return q()}finally{m=Z}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(q,Y){switch(q){case 1:case 2:case 3:case 4:case 5:break;default:q=3}var Z=m;m=q;try{return Y()}finally{m=Z}},t.unstable_scheduleCallback=function(q,Y,Z){var we=t.unstable_now();switch(typeof Z=="object"&&Z!==null?(Z=Z.delay,Z=typeof Z=="number"&&0<Z?we+Z:we):Z=we,q){case 1:var Ne=-1;break;case 2:Ne=250;break;case 5:Ne=1073741823;break;case 4:Ne=1e4;break;default:Ne=5e3}return Ne=Z+Ne,q={id:f++,callback:Y,priorityLevel:q,startTime:Z,expirationTime:Ne,sortIndex:-1},Z>we?(q.sortIndex=Z,e(c,q),n(u)===null&&q===n(c)&&(C?(w(g),g=-1):C=!0,At(V,Z-we))):(q.sortIndex=Ne,e(u,q),R||T||(R=!0,pe(O))),q},t.unstable_shouldYield=P,t.unstable_wrapCallback=function(q){var Y=m;return function(){var Z=m;m=Y;try{return q.apply(this,arguments)}finally{m=Z}}}})(tw);ew.exports=tw;var g1=ew.exports;/**
 * @license React
...
*/var Sr,QE;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(v,g){function I(){}I.prototype=g.prototype,v.F=g.prototype,v.prototype=new I,v.prototype.constructor=v,v.D=function(A,P,x){for(var S=Array(arguments.length-2),Ue=2;Ue<arguments.length;Ue++)S[Ue-2]=arguments[Ue];return g.prototype[P].apply(A,S)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(r,n),r.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(v,g,I){I||(I=0);const A=Array(16);if(typeof g=="string")for(var P=0;P<16;++P)A[P]=g.charCodeAt(I++)|g.charCodeAt(I++)<<8|g.charCodeAt(I++)<<16|g.charCodeAt(I++)<<24;else for(P=0;P<16;++P)A[P]=g[I++]|g[I++]<<8|g[I++]<<16|g[I++]<<24;g=v.g[0],I=v.g[1],P=v.g[2];let x=v.g[3],S;S=g+(x^I&(P^x))+A[0]+3614090360&4294967295,g=I+(S<<7&4294967295|S>>>25),S=x+(P^g&(I^P))+A[1]+3905402710&4294967295,x=g+(S<<12&4294967295|S>>>20),S=P+(I^x&(g^I))+A[2]+606105819&4294967295,P=x+(S<<17&4294967295|S>>>15),S=I+(g^P&(x^g))+A[3]+3250441966&4294967295,I=P+(S<<22&4294967295|S>>>10),S=g+(x^I&(P^x))+A[4]+4118548399&4294967295,g=I+(S<<7&4294967295|S>>>25),S=x+(P^g&(I^P))+A[5]+1200080426&4294967295,x=g+(S<<12&4294967295|S>>>20),S=P+(I^x&(g^I))+A[6]+2821735955&4294967295,P=x+(S<<17&4294967295|S>>>15),S=I+(g^P&(x^g))+A[7]+4249261313&4294967295,I=P+(S<<22&4294967295|S>>>10),S=g+(x^I&(P^x))+A[8]+1770035416&4294967295,g=I+(S<<7&4294967295|S>>>25),S=x+(P^g&(I^P))+A[9]+2336552879&4294967295,x=g+(S<<12&4294967295|S>>>20),S=P+(I^x&(g^I))+A[10]+4294925233&4294967295,P=x+(S<<17&4294967295|S>>>15),S=I+(g^P&(x^g))+A[11]+2304563134&4294967295,I=P+(S<<22&4294967295|S>>>10),S=g+(x^I&(P^x))+A[12]+1804603682&4294967295,g=I+(S<<7&4294967295|S>>>25),S=x+(P^g&(I^P))+A[13]+4254626195&4294967295,x=g+(S<<12&4294967295|S>>>20),S=P+(I^x&(g^I))+A[14]+2792965006&4294967295,P=x+(S<<17&4294967295|S>>>15),S=I+(g^P&(x^g))+A[15]+1236535329&4294967295,I=P+(S<<22&4294967295|S>>>10),S=g+(P^x&(I^P))+A[1]+4129170786&4294967295,g=I+(S<<5&4294967295|S>>>27),S=x+(I^P&(g^I))+A[6]+3225465664&4294967295,x=g+(S<<9&4294967295|S>>>23),S=P+(g^I&(x^g))+A[11]+643717713&4294967295,P=x+(S<<14&4294967295|S>>>18),S=I+(x^g&(P^x))+A[0]+3921069994&4294967295,I=P+(S<<20&4294967295|S>>>12),S=g+(P^x&(I^P))+A[5]+3593408605&4294967295,g=I+(S<<5&4294967295|S>>>27),S=x+(I^P&(g^I))+A[10]+38016083&4294967295,x=g+(S<<9&4294967295|S>>>23),S=P+(g^I&(x^g))+A[15]+3634488961&4294967295,P=x+(S<<14&4294967295|S>>>18),S=I+(x^g&(P^x))+A[4]+3889429448&4294967295,I=P+(S<<20&4294967295|S>>>12),S=g+(P^x&(I^P))+A[9]+568446438&4294967295,g=I+(S<<5&4294967295|S>>>27),S=x+(I^P&(g^I))+A[14]+3275163606&4294967295,x=g+(S<<9&4294967295|S>>>23),S=P+(g^I&(x^g))+A[3]+4107603335&4294967295,P=x+(S<<14&4294967295|S>>>18),S=I+(x^g&(P^x))+A[8]+1163531501&4294967295,I=P+(S<<20&4294967295|S>>>12),S=g+(P^x&(I^P))+A[13]+2850285829&4294967295,g=I+(S<<5&4294967295|S>>>27),S=x+(I^P&(g^I))+A[2]+4243563512&4294967295,x=g+(S<<9&4294967295|S>>>23),S=P+(g^I&(x^g))+A[7]+1735328473&4294967295,P=x+(S<<14&4294967295|S>>>18),S=I+(x^g&(P^x))+A[12]+2368359562&4294967295,I=P+(S<<20&4294967295|S>>>12),S=g+(I^P^x)+A[5]+4294588738&4294967295,g=I+(S<<4&4294967295|S>>>28),S=x+(g^I^P)+A[8]+2272392833&4294967295,x=g+(S<<11&4294967295|S>>>21),S=P+(x^g^I)+A[11]+1839030562&4294967295,P=x+(S<<16&4294967295|S>>>16),S=I+(P^x^g)+A[14]+4259657740&4294967295,I=P+(S<<23&4294967295|S>>>9),S=g+(I^P^x)+A[1]+2763975236&4294967295,g=I+(S<<4&4294967295|S>>>28),S=x+(g^I^P)+A[4]+1272893353&4294967295,x=g+(S<<11&4294967295|S>>>21),S=P+(x^g^I)+A[7]+4139469664&4294967295,P=x+(S<<16&4294967295|S>>>16),S=I+(P^x^g)+A[10]+3200236656&4294967295,I=P+(S<<23&4294967295|S>>>9),S=g+(I^P^x)+A[13]+681279174&4294967295,g=I+(S<<4&4294967295|S>>>28),S=x+(g^I^P)+A[0]+3936430074&4294967295,x=g+(S<<11&4294967295|S>>>21),S=P+(x^g^I)+A[3]+3572445317&4294967295,P=x+(S<<16&4294967295|S>>>16),S=I+(P^x^g)+A[6]+76029189&4294967295,I=P+(S<<23&4294967295|S>>>9),S=g+(I^P^x)+A[9]+3654602809&4294967295,g=I+(S<<4&4294967295|S>>>28),S=x+(g^I^P)+A[12]+3873151461&4294967295,x=g+(S<<11&4294967295|S>>>21),S=P+(x^g^I)+A[15]+530742520&4294967295,P=x+(S<<16&4294967295|S>>>16),S=I+(P^x^g)+A[2]+3299628645&4294967295,I=P+(S<<23&4294967295|S>>>9),S=g+(P^(I|~x))+A[0]+4096336452&4294967295,g=I+(S<<6&4294967295|S>>>26),S=x+(I^(g|~P))+A[7]+1126891415&4294967295,x=g+(S<<10&4294967295|S>>>22),S=P+(g^(x|~I))+A[14]+2878612391&4294967295,P=x+(S<<15&4294967295|S>>>17),S=I+(x^(P|~g))+A[5]+4237533241&4294967295,I=P+(S<<21&4294967295|S>>>11),S=g+(P^(I|~x))+A[12]+1700485571&4294967295,g=I+(S<<6&4294967295|S>>>26),S=x+(I^(g|~P))+A[3]+2399980690&4294967295,x=g+(S<<10&4294967295|S>>>22),S=P+(g^(x|~I))+A[10]+4293915773&4294967295,P=x+(S<<15&4294967295|S>>>17),S=I+(x^(P|~g))+A[1]+2240044497&4294967295,I=P+(S<<21&4294967295|S>>>11),S=g+(P^(I|~x))+A[8]+1873313359&4294967295,g=I+(S<<6&4294967295|S>>>26),S=x+(I^(g|~P))+A[15]+4264355552&4294967295,x=g+(S<<10&4294967295|S>>>22),S=P+(g^(x|~I))+A[6]+2734768916&4294967295,P=x+(S<<15&4294967295|S>>>17),S=I+(x^(P|~g))+A[13]+1309151649&4294967295,I=P+(S<<21&4294967295|S>>>11),S=g+(P^(I|~x))+A[4]+4149444226&4294967295,g=I+(S<<6&4294967295|S>>>26),S=x+(I^(g|~P))+A[11]+3174756917&4294967295,x=g+(S<<10&4294967295|S>>>22),S=P+(g^(x|~I))+A[2]+718787259&4294967295,P=x+(S<<15&4294967295|S>>>17),S=I+(x^(P|~g))+A[9]+3951481745&4294967295,v.g[0]=v.g[0]+g&4294967295,v.g[1]=v.g[1]+(P+(S<<21&4294967295|S>>>11))&4294967295,v.g[2]=v.g[2]+P&4294967295,v.g[3]=v.g[3]+x&4294967295}r.prototype.v=function(v,g){g===void 0&&(g=v.length);const I=g-this.blockSize,A=this.C;let P=this.h,x=0;for(;x<g;){if(P==0)for(;x<=I;)i(this,v,x),x+=this.blockSize;if(typeof v=="string"){for(;x<g;)if(A[P++]=v.charCodeAt(x++),P==this.blockSize){i(this,A),P=0;break}}else for(;x<g;)if(A[P++]=v[x++],P==this.blockSize){i(this,A),P=0;break}}this.h=P,this.o+=g},r.prototype.A=function(){var v=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);v[0]=128;for(var g=1;g<v.length-8;++g)v[g]=0;g=this.o*8;for(var I=v.length-8;I<v.length;++I)v[I]=g&255,g/=256;for(this.v(v),v=Array(16),g=0,I=0;I<4;++I)for(let A=0;A<32;A+=8)v[g++]=this.g[I]>>>A&255;return v};function s(v,g){var I=l;return Object.prototype.hasOwnProperty.call(I,v)?I[v]:I[v]=g(v)}function o(v,g){this.h=g;const I=[];let A=!0;for(let P=v.length-1;P>=0;P--){const x=v[P]|0;A&&x==g||(I[P]=x,A=!1)}this.g=I}var l={};function u(v){return-128<=v&&v<128?s(v,function(g){return new o([g|0],g<0?-1:0)}):new o([v|0],v<0?-1:0)}function c(v){if(isNaN(v)||!isFinite(v))return p;if(v<0)return D(c(-v));const g=[];let I=1;for(let A=0;v>=I;A++)g[A]=v/I|0,I*=4294967296;return new o(g,0)}function f(v,g){if(v.length==0)throw Error("number format error: empty string");if(g=g||10,g<2||36<g)throw Error("radix out of range: "+g);if(v.charAt(0)=="-")return D(f(v.substring(1),g));if(v.indexOf("-")>=0)throw Error('number format error: interior "-" character');const I=c(Math.pow(g,8));let A=p;for(let x=0;x<v.length;x+=8){var P=Math.min(8,v.length-x);const S=parseInt(v.substring(x,x+P),g);P<8?(P=c(Math.pow(g,P)),A=A.j(P).add(c(S))):(A=A.j(I),A=A.add(c(S)))}return A}var p=u(0),m=u(1),T=u(16777216);t=o.prototype,t.m=function(){if(C(this))return-D(this).m();let v=0,g=1;for(let I=0;I<this.g.length;I++){const A=this.i(I);v+=(A>=0?A:4294967296+A)*g,g*=4294967296}return v},t.toString=function(v){if(v=v||10,v<2||36<v)throw Error("radix out of range: "+v);if(R(this))return"0";if(C(this))return"-"+D(this).toString(v);const g=c(Math.pow(v,6));var I=this;let A="";for(;;){const P=V(I,g).g;I=w(I,P.j(g));let x=((I.g.length>0?I.g[0]:I.h)>>>0).toString(v);if(I=P,R(I))return x+A;for(;x.length<6;)x="0"+x;A=x+A}},t.i=function(v){return v<0?0:v<this.g.length?this.g[v]:this.h};function R(v){if(v.h!=0)return!1;for(let g=0;g<v.g.length;g++)if(v.g[g]!=0)return!1;return!0}function C(v){return v.h==-1}t.l=function(v){return v=w(this,v),C(v)?-1:R(v)?0:1};function D(v){const g=v.g.length,I=[];for(let A=0;A<g;A++)I[A]=~v.g[A];return new o(I,~v.h).add(m)}t.abs=function(){return C(this)?D(this):this},t.add=function(v){const g=Math.max(this.g.length,v.g.length),I=[];let A=0;for(let P=0;P<=g;P++){let x=A+(this.i(P)&65535)+(v.i(P)&65535),S=(x>>>16)+(this.i(P)>>>16)+(v.i(P)>>>16);A=S>>>16,x&=65535,S&=65535,I[P]=S<<16|x}return new o(I,I[I.length-1]&-2147483648?-1:0)};function w(v,g){return v.add(D(g))}t.j=function(v){if(R(this)||R(v))return p;if(C(this))return C(v)?D(this).j(D(v)):D(D(this).j(v));if(C(v))return D(this.j(D(v)));if(this.l(T)<0&&v.l(T)<0)return c(this.m()*v.m());const g=this.g.length+v.g.length,I=[];for(var A=0;A<2*g;A++)I[A]=0;for(A=0;A<this.g.length;A++)for(let P=0;P<v.g.length;P++){const x=this.i(A)>>>16,S=this.i(A)&65535,Ue=v.i(P)>>>16,fe=v.i(P)&65535;I[2*A+2*P]+=S*fe,_(I,2*A+2*P),I[2*A+2*P+1]+=x*fe,_(I,2*A+2*P+1),I[2*A+2*P+1]+=S*Ue,_(I,2*A+2*P+1),I[2*A+2*P+2]+=x*Ue,_(I,2*A+2*P+2)}for(v=0;v<g;v++)I[v]=I[2*v+1]<<16|I[2*v];for(v=g;v<2*g;v++)I[v]=0;return new o(I,0)};function _(v,g){for(;(v[g]&65535)!=v[g];)v[g+1]+=v[g]>>>16,v[g]&=65535,g++}function E(v,g){this.g=v,this.h=g}function V(v,g){if(R(g))throw Error("division by zero");if(R(v))return new E(p,p);if(C(v))return g=V(D(v),g),new E(D(g.g),D(g.h));if(C(g))return g=V(v,D(g)),new E(D(g.g),g.h);if(v.g.length>30){if(C(v)||C(g))throw Error("slowDivide_ only works with positive integers.");for(var I=m,A=g;A.l(v)<=0;)I=O(I),A=O(A);var P=L(I,1),x=L(A,1);for(A=L(A,2),I=L(I,2);!R(A);){var S=x.add(A);S.l(v)<=0&&(P=P.add(I),x=S),A=L(A,1),I=L(I,1)}return g=w(v,P.j(g)),new E(P,g)}for(P=p;v.l(g)>=0;){for(I=Math.max(1,Math.floor(v.m()/g.m())),A=Math.ceil(Math.log(I)/Math.LN2),A=A<=48?1:Math.pow(2,A-48),x=c(I),S=x.j(g);C(S)||S.l(v)>0;)I-=A,x=c(I),S=x.j(g);R(x)&&(x=m),P=P.add(x),v=w(v,S)}return new E(P,v)}t.B=function(v){return V(this,v).h},t.and=function(v){const g=Math.max(this.g.length,v.g.length),I=[];for(let A=0;A<g;A++)I[A]=this.i(A)&v.i(A);return new o(I,this.h&v.h)},t.or=function(v){const g=Math.max(this.g.length,v.g.length),I=[];for(let A=0;A<g;A++)I[A]=this.i(A)|v.i(A);return new o(I,this.h|v.h)},t.xor=function(v){const g=Math.max(this.g.length,v.g.length),I=[];for(let A=0;A<g;A++)I[A]=this.i(A)^v.i(A);return new o(I,this.h^v.h)};function O(v){const g=v.g.length+1,I=[];for(let A=0;A<g;A++)I[A]=v.i(A)<<1|v.i(A-1)>>>31;return new o(I,v.h)}function L(v,g){const I=g>>5;g%=32;const A=v.g.length-I,P=[];for(let x=0;x<A;x++)P[x]=g>0?v.i(x+I)>>>g|v.i(x+I+1)<<32-g:v.i(x+I);return new o(P,v.h)}r.prototype.digest=r.prototype.A,r.prototype.reset=r.prototype.u,r.prototype.update=r.prototype.v,QE=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.B,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=c,o.fromString=f,Sr=o}).apply(typeof y_<"u"?y_:typeof self<"u"?self:typeof window<"u"?window:{});var Ol=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pa=-1;class Qu{constructor(e,n,r,i){this.indexId=e,this.collectionGroup=n,this.fields=r,this.indexState=i}}function yf(t){return t.fields.find(e=>e.kind===2)}function Yr(t){return t.fields.filter(e=>e.kind!==2)}Qu.UNKNOWN_ID=-1;class ou{constructor(e,n){this.fieldPath=e,this.kind=n}}class Ra{constructor(e,n){this.sequenceNumber=e,this.offset=n}static empty(){return new Ra(0,Vt.min())}}function mx(t,e){const n=t.toTimestamp().seconds,r=t.toTimestamp().nanoseconds+1,i=W.fromTimestamp(r===1e9?new ue(n+1,0):new ue(n,r));return new Vt(i,$.empty(),e)}function oT(t){return new Vt(t.readTime,t.key,Pa)}class Vt{constructor(e,n,r){this.readTime=e,this.documentKey=n,this.largestBatchId=r}static min(){return new Vt(W.min(),$.empty(),Pa)}static max(){return new Vt(W.max(),$.empty(),Pa)}}function Xp(t,e){let n=t.readTime.compareTo(e.readTime);return n!==0?n:(n=$.comparator(t.documentKey,e.documentKey),n!==0?n:X(t.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fe{constructor(e){this.binaryString=e}static fromBase64String(e){const n=function(i){try{return atob(i)}catch(s){throw typeof DOMException<"u"&&s instanceof DOMException?new IT("Invalid base64 string: "+s):s}}(e);return new Fe(n)}static fromUint8Array(e){const n=function(i){let s="";for(let o=0;o<i.length;++o)s+=String.fromCharCode(i[o]);return s}(e);return new Fe(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(n){return btoa(n)}(this.binaryString)}toUint8Array(){return function(n){const r=new Uint8Array(n.length);for(let i=0;i<n.length;i++)r[i]=n.charCodeAt(i);return r}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return X(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}Fe.EMPTY_BYTE_STRING=new Fe("");const Kx=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function Ln(t){if(K(!!t,39018),typeof t=="string"){let e=0;const n=Kx.exec(t);if(K(!!n,46558,{timestamp:t}),n[1]){let i=n[1];i=(i+"000000000").substr(0,9),e=Number(i)}const r=new Date(t);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:Ie(t.seconds),nanos:Ie(t.nanos)}}function Ie(t){return typeof t=="number"?t:typeof t=="string"?Number(t):0}function Fn(t){return typeof t=="string"?Fe.fromBase64String(t):Fe.fromUint8Array(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $c{constructor(e,n,r,i,s){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=r,this.documentUpdates=i,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,n,r){const i=new Map;return i.set(e,el.createSynthesizedTargetChangeForCurrentChange(e,n,r)),new $c(W.min(),i,new Te(X),xt(),te())}}class el{constructor(e,n,r,i,s){this.resumeToken=e,this.current=n,this.addedDocuments=r,this.modifiedDocuments=i,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,n,r){return new el(r,n,te(),te(),te())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class jV{constructor(e,n){this._firestore=e,this._commitHandler=n,this._mutations=[],this._committed=!1,this._dataReader=Zc(e)}set(e,n,r){this._verifyNotCommitted();const i=cd(e,this._firestore),s=gS(i.converter,n,r),o=sS(this._dataReader,"WriteBatch.set",i._key,s,i.converter!==null,r);return this._mutations.push(o.toMutation(i._key,We.none())),this}update(e,n,r,...i){this._verifyNotCommitted();const s=cd(e,this._firestore);let o;return o=typeof(n=Le(n))=="string"||n instanceof Xc?aS(this._dataReader,"WriteBatch.update",s._key,n,r,i):oS(this._dataReader,"WriteBatch.update",s._key,n),this._mutations.push(o.toMutation(s._key,We.exists(!0))),this}delete(e){this._verifyNotCommitted();const n=cd(e,this._firestore);return this._mutations=this._mutations.concat(new Za(n._key,We.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new B(M.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function cd(t,e){if((t=Le(t)).firestore!==e)throw new B(M.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return t}function BV(t){t=$t(t,Fr);const e=$t(t.firestore,Un),n=Yc(e),r=new Dm(e);return fS(t._query),EV(n,t._query).then(i=>new mi(e,r,t,i))}function zV(t,e,n,...r){t=$t(t,Me);const i=$t(t.firestore,Un),s=Zc(i);let o;return o=typeof(e=Le(e))=="string"||e instanceof Xc?aS(s,"updateDoc",t._key,e,n,r):oS(s,"updateDoc",t._key,e),nh(i,[o.toMutation(t._key,We.exists(!0))])}function $V(t){return nh($t(t.firestore,Un),[new Za(t._key,We.none())])}function hd(t,e){const n=$t(t.firestore,Un),r=Jr(t),i=gS(t.converter,e),s=Zc(t.firestore);return nh(n,[sS(s,"addDoc",r._key,i,t.converter!==null,{}).toMutation(r._key,We.exists(!1))]).then(()=>r)}function Bv(t,...e){var c,f,p;t=Le(t);let n={includeMetadataChanges:!1,source:"default"},r=0;typeof e[r]!="object"||Lv(e[r])||(n=e[r++]);const i={includeMetadataChanges:n.includeMetadataChanges,source:n.source};if(Lv(e[r])){const m=e[r];e[r]=(c=m.next)==null?void 0:c.bind(m),e[r+1]=(f=m.error)==null?void 0:f.bind(m),e[r+2]=(p=m.complete)==null?void 0:p.bind(m)}let s,o,l;if(t instanceof Me)o=$t(t.firestore,Un),l=Uc(t._key.path),s={next:m=>{e[r]&&e[r](qV(o,t,m))},error:e[r+1],complete:e[r+2]};else{const m=$t(t,Fr);o=$t(m.firestore,Un),l=m._query;const T=new Dm(o);s={next:R=>{e[r]&&e[r](new mi(o,T,m,R))},error:e[r+1],complete:e[r+2]},fS(t._query)}const u=Yc(o);return IV(u,l,i,s)}function nh(t,e){const n=Yc(t);return TV(n,e)}function qV(t,e,n){const r=n.docs.get(e._key),i=new Dm(t);return new pi(t,i,e._key,r,new Bo(n.hasPendingWrites,n.fromCache),e.converter)}function dd(t){return t=$t(t,Un),Yc(t),new jV(t,e=>nh(t,e))}(function(e,n=!0){rx(Ys),xs(new Ei("firestore",(r,{instanceIdentifier:i,options:s})=>{const o=r.getProvider("app").getImmediate(),l=new Un(new ox(r.getProvider("auth-internal")),new ux(o,r.getProvider("app-check-internal")),Qx(o,i),o);return s={useFetchStreams:n,...s},l._setSettings(s),l},"PUBLIC").setMultipleInstances(!0)),Tr(Ov,Mv,e),Tr(Ov,Mv,"esm2020")})();const HV={apiKey:"AIzaSyBSFq7YkTgMA4gr1AfBxWXbWoBn7JLozQw",authDomain:"guiter-code-ad4df.firebaseapp.com",projectId:"guiter-code-ad4df",storageBucket:"guiter-code-ad4df.firebasestorage.app",messagingSenderId:"474318515571",appId:"1:474318515571:web:8b128de0df7a71eef42906",measurementId:"G-6DGZLTRB7M"},yS=mE(HV),Bf=tx(yS),GV=new Tn,dt=RV(yS);try{CV(dt).catch(t=>{t.code==="failed-precondition"?console.warn("Firestore persistence failed: Multiple tabs open"):t.code==="unimplemented"&&console.warn("Firestore persistence failed: Browser not supported")})}catch(t){console.error("Persistence setup error:",t)}const Wi="guitar_scroll_songs";function KV(t){const[e,n]=re.useState([]),[r,i]=re.useState(null),[s,o]=re.useState(!0),[l,u]=re.useState([]);re.useEffect(()=>{if(!t){const D=localStorage.getItem(Wi);if(D){let w=JSON.parse(D);w.length>0&&w[0].orderIndex===void 0&&(w=w.sort((_,E)=>E.createdAt-_.createdAt).map((_,E)=>({..._,orderIndex:E})),localStorage.setItem(Wi,JSON.stringify(w))),n(w.sort((_,E)=>_.orderIndex-E.orderIndex))}else n([]);o(!1)}},[t]),re.useEffect(()=>{if(!t)return;o(!0);const D=Fv(Ki(dt,"songs"),LV("userId","==",t.uid)),w=Bv(D,_=>{let E=_.docs.map(O=>{var v;const L=O.data();return{id:O.id,...L,createdAt:(v=L.createdAt)!=null&&v.toMillis?L.createdAt.toMillis():Date.now()}});if(E.some(O=>O.orderIndex===void 0)){E=E.sort((L,v)=>(L.createdAt||0)-(v.createdAt||0)).map((L,v)=>({...L,orderIndex:v}));const O=dd(dt);E.forEach(L=>{const v=Jr(dt,"songs",L.id);O.update(v,{orderIndex:L.orderIndex})}),O.commit().catch(L=>console.error("Migration failed:",L))}else E.sort((O,L)=>(O.orderIndex||0)-(L.orderIndex||0));n(E),o(!1)},_=>{console.error("[Firestore] Sync error:",_),o(!1)});return()=>w()},[t]),re.useEffect(()=>{if(!t||!r){u([]);return}const D=Ki(dt,"songs",r,"pages"),w=Fv(D,FV("pageIndex","asc")),_=Bv(w,E=>{const V=E.docs.map(O=>O.data().url);u(V)},E=>{console.error("[Firestore] Pages sync error:",E)});return()=>_()},[t,r]);const c=re.useCallback(async D=>{const w=e.length>0?Math.max(...e.map(O=>O.orderIndex||0))+1:0,{imageUrls:_,...E}=D,V={title:"名称未設定の曲",artist:"",bpm:120,scrollSpeed:20,orderIndex:w,...E};if(t)try{const L={id:`temp-${Date.now()}`,...V,createdAt:Date.now(),isOptimistic:!0,imageUrls:_};n(g=>[...g,L]),console.log("[Firestore] Saving song metadata...");const v=await hd(Ki(dt,"songs"),{...V,userId:t.uid,createdAt:zl()});if(_&&_.length>0){console.log(`[Firestore] Saving ${_.length} pages...`);for(let g=0;g<_.length;g++){const I=_[g];if(I.length>1e6)throw new Error(`画像 ${g+1} 枚目が大きすぎます (1MB超)`);const A=Jr(Ki(dt,"songs",v.id,"pages"));await hd(Ki(dt,"songs",v.id,"pages"),{url:I,pageIndex:g,createdAt:zl()})}}return console.log("[Firestore] Add successful"),{id:v.id,...V,imageUrls:_}}catch(O){throw console.error("[Firestore] Add error detailed:",O),O}else{const O={id:crypto.randomUUID(),...V,imageUrls:_,createdAt:Date.now()},L=[...e,O].sort((v,g)=>v.orderIndex-g.orderIndex);return n(L),localStorage.setItem(Wi,JSON.stringify(L)),O}},[t,e]),f=re.useCallback(async(D,w)=>{const{imageUrls:_,...E}=w;if(t)try{console.log("[Firestore] Updating song metadata:",D);const V=Jr(dt,"songs",D);await zV(V,{...E,imageUrls:[],imageUrl:"",updatedAt:zl()}),console.log("[Firestore] Syncing pages...");const O=Ki(dt,"songs",D,"pages"),L=await BV(O),v=dd(dt);if(L.forEach(g=>v.delete(g.ref)),await v.commit(),_&&_.length>0)for(let g=0;g<_.length;g++){const I=_[g];if(I.length>1048487)throw new Error(`画像 ${g+1} 枚目が大きすぎます`);await hd(O,{url:I,pageIndex:g,createdAt:zl()})}console.log("[Firestore] Update successful")}catch(V){throw console.error("[Firestore] Update error detailed:",V),V}else{const V=e.map(O=>O.id===D?{...O,...E,imageUrls:_}:O);n(V),localStorage.setItem(Wi,JSON.stringify(V))}},[t,e]),p=re.useCallback(async D=>{if(t)try{await $V(Jr(dt,"songs",D))}catch(w){throw console.error("[Firestore] Delete error:",w),w}else{const w=e.filter(_=>_.id!==D);n(w),localStorage.setItem(Wi,JSON.stringify(w))}r===D&&i(null)},[t,e,r]),m=re.useCallback(async(D,w)=>{const _=e.findIndex(g=>g.id===D);if(_<0)return;const E=_+w;if(E<0||E>=e.length)return;const V=[...e],O={...V[_]},L={...V[E]},v=O.orderIndex;if(O.orderIndex=L.orderIndex,L.orderIndex=v,t)try{const g=dd(dt);g.update(Jr(dt,"songs",O.id),{orderIndex:O.orderIndex}),g.update(Jr(dt,"songs",L.id),{orderIndex:L.orderIndex}),await g.commit()}catch(g){console.error("[Firestore] Move error:",g)}else V[_]=O,V[E]=L,V.sort((g,I)=>g.orderIndex-I.orderIndex),n(V),localStorage.setItem(Wi,JSON.stringify(V))},[t,e]),T=e.find(D=>D.id===r)||null,R=t?l.length>0?l:(T==null?void 0:T.imageUrls)||[]:(T==null?void 0:T.imageUrls)||[],C=T?{...T,imageUrls:R}:null;return{songs:e,currentSong:C,currentSongId:r,setCurrentSongId:i,addSong:c,updateSong:f,deleteSong:p,moveSong:m,loading:s}}function WV({songs:t,currentSongId:e,onSelect:n,onMove:r}){return F.jsxs("div",{className:"song-list-container",children:[t.length===0?F.jsx("div",{className:"empty-msg",children:"楽曲が登録されていません"}):F.jsx("ul",{className:"list-items",children:t.map((i,s)=>F.jsxs("li",{className:`song-item ${i.id===e?"active":""}`,onClick:()=>n(i.id),children:[F.jsxs("div",{className:"song-main",children:[F.jsx("div",{className:"song-title",children:i.title}),F.jsxs("div",{className:"song-meta",children:[i.artist||"Unknown"," / BPM: ",i.bpm]})]}),F.jsxs("div",{className:"song-reorder",onClick:o=>o.stopPropagation(),children:[F.jsx("button",{className:"reorder-btn",onClick:()=>r(i.id,-1),disabled:s===0,title:"上に移動",children:"▲"}),F.jsx("button",{className:"reorder-btn",onClick:()=>r(i.id,1),disabled:s===t.length-1,title:"下に移動",children:"▼"})]})]},i.id))}),F.jsx("style",{jsx:!0,children:`
      ...
      `})]})}function XV({song:t,isPlaying:e,scrollSpeed:n,scrollPos:r,onScrollUpdate:i,onTogglePlay:s}){const o=re.useRef(null),l=re.useRef({x:0,y:0,time:0}),{imageUrls:u,imageUrl:c}=t,f=u||(c?[c]:[]);re.useEffect(()=>{let R,C=performance.now();const D=w=>{if(e){const _=(w-C)/1e3,E=n*_;i(V=>V+E)}C=w,R=requestAnimationFrame(D)};return R=requestAnimationFrame(D),()=>cancelAnimationFrame(R)},[e,n,i]),re.useEffect(()=>{o.current&&Math.abs(o.current.scrollTop-r)>1&&(o.current.scrollTop=r)},[r]);const p=R=>{e||i(R.target.scrollTop)},m=R=>{l.current={x:R.clientX,y:R.clientY,time:Date.now()}},T=R=>{const C=Date.now()-l.current.time,D=Math.abs(R.clientX-l.current.x),w=Math.abs(R.clientY-l.current.y);C<300&&D<10&&w<10&&s()};return F.jsxs("div",{className:"chord-viewer",ref:o,onScroll:p,onPointerDown:m,onPointerUp:T,children:[F.jsx("div",{className:"chord-content-wrapper",children:f.length>0?F.jsx("div",{className:"images-stack",children:f.map((R,C)=>F.jsx("img",{src:R,alt:`Sheet Music Page ${C+1}`,className:"sheet-image"},C))}):F.jsx("div",{className:"no-image-msg",children:"楽譜画像がありません"})}),F.jsx("style",{jsx:!0,children:`
        .chord-viewer {
          width: 100%;
          height: 100%;
          overflow-y: auto;
      ...
      `})]})}const eb=400;function tb(){const[t,e]=re.useState(null),[n,r]=re.useState(window.innerWidth<768),[i,s]=re.useState(!0),o=re.useRef(null);re.useEffect(()=>{const fe=$C(Bf,pe=>{e(pe)});return()=>fe()},[]);const{songs:l,currentSong:u,currentSongId:c,setCurrentSongId:f,addSong:p,updateSong:m,deleteSong:T,moveSong:R,loading:C}=KV(t),[D,w]=re.useState(!1),[_,E]=re.useState(!1),[V,O]=re.useState(0),[L,v]=re.useState(20),g=re.useCallback(fe=>{if(s(!0),o.current&&clearTimeout(o.current),u&&!D){const pe=_?1e3:2e3;o.current=setTimeout(()=>{s(!1)},pe)}},[_,u,D]);re.useEffect(()=>(s(!0),g(),()=>{o.current&&clearTimeout(o.current)}),[_,u,D]);const I=re.useCallback(()=>{E(fe=>!fe)},[]),A=re.useCallback(()=>{E(!1),O(0)},[]);re.useEffect(()=>{const fe=pe=>{pe.code==="Space"&&!D&&(pe.preventDefault(),I()),pe.code==="KeyS"&&!D&&r(At=>!At)};return window.addEventListener("keydown",fe),()=>window.removeEventListener("keydown",fe)},[I,D]);const P=re.useCallback(()=>{if(u!=null&&u.bpm){const fe=u.bpm/60/4*eb;v(Math.round(fe))}},[u]),x=fe=>{f(fe),w(!1),A();const pe=l.find(At=>At.id===fe);pe!=null&&pe.scrollSpeed&&v(pe.scrollSpeed)},S=async fe=>{try{if(c)await m(c,{...fe,scrollSpeed:L});else{const pe=await p({...fe,scrollSpeed:L});pe&&pe.id&&f(pe.id)}w(!1)}catch(pe){let At="保存に失敗しました。";pe.message&&(At+=`
原因: ${pe.message}`),pe.code==="permission-denied"&&(At+=`
設定エラー: データベースの書き込み権限がありません。管理者にお問い合わせください。`),alert(At),console.error(pe)}},Ue=async fe=>{window.confirm("この曲を削除してもよろしいですか？")&&(await T(fe),w(!1))};return F.jsxs("div",{className:`app-container ${n?"sidebar-collapsed":""}`,onPointerDown:g,onMouseMove:g,children:[F.jsxs("nav",{className:"sidebar",children:[F.jsxs("div",{className:"sidebar-header",children:[F.jsx("h1",{children:"Guitar Scroll"}),F.jsx("button",{className:"toggle-btn",onClick:()=>r(!0),children:"◀"})]}),F.jsx(ZV,{user:t}),F.jsx(WV,{songs:l,currentSongId:c,onSelect:x,onMove:R}),F.jsx("div",{className:"sidebar-footer",children:F.jsx("button",{className:"add-button",onClick:()=>{f(null),w(!0)},children:"＋ 新しい曲"})})]}),F.jsxs("main",{className:"main-content",children:[F.jsxs("header",{className:`app-header ${i?"":"header-hidden"}`,children:[F.jsx("div",{className:"song-info",children:u?F.jsxs(F.Fragment,{children:[F.jsx("h2",{children:u.title}),F.jsxs("span",{className:"metadata",children:[u.artist," | BPM: ",u.bpm]})]}):F.jsx("h2",{children:C?"読み込み中...":"曲を選択してください"})}),F.jsx("div",{className:"app-actions",children:u&&F.jsx("button",{className:"edit-toggle",onClick:()=>w(!D),children:D?"完了":"編集"})})]}),F.jsx("section",{className:"viewer-area",children:D?F.jsx(YV,{song:u,onSave:S,onCancel:()=>w(!1),onDelete:Ue}):u?F.jsx(XV,{song:u,isPlaying:_,scrollSpeed:L,scrollPos:V,onScrollUpdate:O,onTogglePlay:I}):F.jsx("div",{className:"placeholder-msg",children:F.jsx("p",{children:"曲を選択するか「＋ 新しい曲」から楽譜画像を追加してください。"})})}),(u||n&&!D)&&F.jsx("footer",{className:`controls-area floating-panel ${i?"":"controls-hidden"}`,children:F.jsxs("div",{className:"floating-inner",children:[F.jsxs("div",{className:"top-row",children:[n&&F.jsx("button",{className:"expand-btn-floating",onClick:()=>r(!1),children:"☰ 曲一覧"}),u&&F.jsx("div",{className:"bpm-sync-panel",children:F.jsx("button",{className:"sync-btn",onClick:P,children:"BPM同期"})})]}),u&&F.jsx(JV,{isPlaying:_,onTogglePlay:I,onReset:A,scrollSpeed:L,onSpeedChange:v})]})})]}),F.jsx("style",{jsx:!0,children:`
        .app-container {
          display: flex;
          height: 100vh;
          height: 100dvh;
