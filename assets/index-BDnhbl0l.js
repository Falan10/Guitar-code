 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Si=new Mp("@firebase/firestore");function Qi(){return Si.logLevel}function U(t,...e){if(Si.logLevel<=ie.DEBUG){const n=e.map(Qp);Si.debug(`Firestore (${Xs}): ${t}`,...n)}}function pt(t,...e){if(Si.logLevel<=ie.ERROR){const n=e.map(Qp);Si.error(`Firestore (${Xs}): ${t}`,...n)}}function Ai(t,...e){if(Si.logLevel<=ie.WARN){const n=e.map(Qp);Si.warn(`Firestore (${Xs}): ${t}`,...n)}}function Qp(t){if(typeof t=="string")return t;try{return function(n){return JSON.stringify(n)}(t)}catch{return t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wx{constructor(e,n,r,i,s,o,l,u,c,f,p){this.databaseId=e,this.appId=n,this.persistenceKey=r,this.host=i,this.ssl=s,this.forceLongPolling=o,this.autoDetectLongPolling=l,this.longPollingOptions=u,this.useFetchStreams=c,this.isUsingEmulator=f,this.apiKey=p}}const Zu="(default)";class Ri{constructor(e,n){this.projectId=e,this.database=n||Zu}static empty(){return new Ri("","")}get isDefaultDatabase(){return this.database===Zu}isEqual(e){return e instanceof Ri&&e.projectId===this.projectId&&e.database===this.database}}function Qx(t,e){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new B(M.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Ri(t.options.projectId,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sN{constructor(e,n=null,r=[],i=[],s=null,o=null,l=null){this.path=e,this.collectionGroup=n,this.orderBy=r,this.filters=i,this.limit=s,this.startAt=o,this.endAt=l,this.Te=null}}function Rf(t,e=null,n=[],r=[],i=null,s=null,o=null){return new sN(t,e,n,r,i,s,o)}function Pi(t){const e=X(t);if(e.Te===null){let n=e.path.canonicalString();e.collectionGroup!==null&&(n+="|cg:"+e.collectionGroup),n+="|f:",n+=e.filters.map(r=>Af(r)).join(","),n+="|ob:",n+=e.orderBy.map(r=>function(s){return s.field.canonicalString()+s.dir}(r)).join(","),Vc(e.limit)||(n+="|l:",n+=e.limit),e.startAt&&(n+="|lb:",n+=e.startAt.inclusive?"b:":"a:",n+=e.startAt.position.map(r=>Fs(r)).join(",")),e.endAt&&(n+="|ub:",n+=e.endAt.inclusive?"a:":"b:",n+=e.endAt.position.map(r=>Fs(r)).join(",")),e.Te=n}return e.Te}function Ja(t,e){if(t.limit!==e.limit||t.orderBy.length!==e.orderBy.length)return!1;for(let n=0;n<t.orderBy.length;n++)if(!Xx(t.orderBy[n],e.orderBy[n]))return!1;if(t.filters.length!==e.filters.length)return!1;for(let n=0;n<t.filters.length;n++)if(!DT(t.filters[n],e.filters[n]))return!1;return t.collectionGroup===e.collectionGroup&&!!t.path.isEqual(e.path)&&!!L_(t.startAt,e.startAt)&&L_(t.endAt,e.endAt)}function ec(t){return $.isDocumentKey(t.path)&&t.collectionGroup===null&&t.filters.length===0}function tc(t,e){return t.filters.filter(n=>n instanceof se&&n.field.isEqual(e))}function F_(t,e,n){let r=uu,i=!0;for(const s of tc(t,e)){let o=uu,l=!0;switch(s.op){case"<":case"<=":o=Yx(s.value);break;case"==":case"in":case">=":o=s.value;break;case">":o=s.value,l=!1;break;case"!=":case"not-in":o=uu}b_({value:r,inclusive:i},{value:o,inclusive:l})<0&&(r=o,i=l)}if(n!==null){for(let s=0;s<t.orderBy.length;++s)if(t.orderBy[s].field.isEqual(e)){const o=n.position[s];b_({value:r,inclusive:i},{value:o,inclusive:n.inclusive})<0&&(r=o,i=n.inclusive);break}}return{value:r,inclusive:i}}function U_(t,e,n){let r=dr,i=!0;for(const s of tc(t,e)){let o=dr,l=!0;switch(s.op){case">=":case">":o=Jx(s.value),l=!1;break;case"==":case"in":case"<=":o=s.value;break;case"<":o=s.value,l=!1;break;case"!=":case"not-in":o=dr}O_({value:r,inclusive:i},{value:o,inclusive:l})>0&&(r=o,i=l)}if(n!==null){for(let s=0;s<t.orderBy.length;++s)if(t.orderBy[s].field.isEqual(e)){const o=n.position[s];O_({value:r,inclusive:i},{value:o,inclusive:n.inclusive})>0&&(r=o,i=n.inclusive);break}}return{value:r,inclusive:i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function v0(t,e,n){const r=t.store(Jt),i=t.store(Vs),s=[],o=IDBKeyRange.only(n.batchId);let l=0;const u=r.ee({range:o},(f,p,m)=>(l++,m.delete()));s.push(u.next(()=>{K(l===1,47070,{batchId:n.batchId})}));const c=[];for(const f of n.mutations){const p=cT(e,f.key.path,n.batchId);s.push(i.delete(p)),c.push(f.key)}return k.waitFor(s).next(()=>c)}function oc(t){if(!t)return 0;let e;if(t.document)e=t.document;else if(t.unknownDocument)e=t.unknownDocument;else{if(!t.noDocument)throw G(14731);e=t.noDocument}return JSON.stringify(e).length}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class jV{constructor(e,n){this._firestore=e,this._commitHandler=n,this._mutations=[],this._committed=!1,this._dataReader=Zc(e)}set(e,n,r){this._verifyNotCommitted();const i=cd(e,this._firestore),s=gS(i.converter,n,r),o=sS(this._dataReader,"WriteBatch.set",i._key,s,i.converter!==null,r);return this._mutations.push(o.toMutation(i._key,We.none())),this}update(e,n,r,...i){this._verifyNotCommitted();const s=cd(e,this._firestore);let o;return o=typeof(n=Le(n))=="string"||n instanceof Jc?aS(this._dataReader,"WriteBatch.update",s._key,n,r,i):oS(this._dataReader,"WriteBatch.update",s._key,n),this._mutations.push(o.toMutation(s._key,We.exists(!0))),this}delete(e){this._verifyNotCommitted();const n=cd(e,this._firestore);return this._mutations=this._mutations.concat(new Za(n._key,We.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new B(M.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function cd(t,e){if((t=Le(t)).firestore!==e)throw new B(M.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return t}function BV(t){t=$t(t,Fr);const e=$t(t.firestore,Un),n=Yc(e),r=new Dm(e);return fS(t._query),EV(n,t._query).then(i=>new mi(e,r,t,i))}function zV(t,e,n,...r){t=$t(t,Me);const i=$t(t.firestore,Un),s=Zc(i);let o;return o=typeof(e=Le(e))=="string"||e instanceof Jc?aS(s,"updateDoc",t._key,e,n,r):oS(s,"updateDoc",t._key,e),nh(i,[o.toMutation(t._key,We.exists(!0))])}function $V(t){return nh($t(t.firestore,Un),[new Za(t._key,We.none())])}function hd(t,e){const n=$t(t.firestore,Un),r=Xr(t),i=gS(t.converter,e),s=Zc(t.firestore);return nh(n,[sS(s,"addDoc",r._key,i,t.converter!==null,{}).toMutation(r._key,We.exists(!1))]).then(()=>r)}function Bv(t,...e){var c,f,p;t=Le(t);let n={includeMetadataChanges:!1,source:"default"},r=0;typeof e[r]!="object"||Lv(e[r])||(n=e[r++]);const i={includeMetadataChanges:n.includeMetadataChanges,source:n.source};if(Lv(e[r])){const m=e[r];e[r]=(c=m.next)==null?void 0:c.bind(m),e[r+1]=(f=m.error)==null?void 0:f.bind(m),e[r+2]=(p=m.complete)==null?void 0:p.bind(m)}let s,o,l;if(t instanceof Me)o=$t(t.firestore,Un),l=Uc(t._key.path),s={next:m=>{e[r]&&e[r](qV(o,t,m))},error:e[r+1],complete:e[r+2]};else{const m=$t(t,Fr);o=$t(m.firestore,Un),l=m._query;const T=new Dm(o);s={next:P=>{e[r]&&e[r](new mi(o,T,m,P))},error:e[r+1],complete:e[r+2]},fS(t._query)}const u=Yc(o);return IV(u,l,i,s)}function nh(t,e){const n=Yc(t);return TV(n,e)}function qV(t,e,n){const r=n.docs.get(e._key),i=new Dm(t);return new pi(t,i,e._key,r,new Bo(n.hasPendingWrites,n.fromCache),e.converter)}function dd(t){return t=$t(t,Un),Yc(t),new jV(t,e=>nh(t,e))}(function(e,n=!0){rx(Ys),xs(new Ei("firestore",(r,{instanceIdentifier:i,options:s})=>{const o=r.getProvider("app").getImmediate(),l=new Un(new ox(r.getProvider("auth-internal")),new ux(o,r.getProvider("app-check-internal")),Qx(o,i),o);return s={useFetchStreams:n,...s},l._setSettings(s),l},"PUBLIC").setMultipleInstances(!0)),Tr(Ov,Mv,e),Tr(Ov,Mv,"esm2020")})();const HV={apiKey:"AIzaSyBSFq7YkTgMA4gr1AfBxWXbWoBn7JLozQw",authDomain:"guiter-code-ad4df.firebaseapp.com",projectId:"guiter-code-ad4df",storageBucket:"guiter-code-ad4df.firebasestorage.app",messagingSenderId:"474318515571",appId:"1:474318515571:web:8b128de0df7a71eef42906",measurementId:"G-6DGZLTRB7M"},yS=mE(HV),Bf=tx(yS),GV=new Tn,dt=PV(yS);try{CV(dt).catch(t=>{t.code==="failed-precondition"?console.warn("Firestore persistence failed: Multiple tabs open"):t.code==="unimplemented"&&console.warn("Firestore persistence failed: Browser not supported")})}catch(t){console.error("Persistence setup error:",t)}const Wi="guitar_scroll_songs";function KV(t){const[e,n]=re.useState([]),[r,i]=re.useState(null),[s,o]=re.useState(!0),[l,u]=re.useState([]);re.useEffect(()=>{if(!t){const D=localStorage.getItem(Wi);if(D){let w=JSON.parse(D);w.length>0&&w[0].orderIndex===void 0&&(w=w.sort((_,E)=>E.createdAt-_.createdAt).map((_,E)=>({..._,orderIndex:E})),localStorage.setItem(Wi,JSON.stringify(w))),n(w.sort((_,E)=>_.orderIndex-E.orderIndex))}else n([]);o(!1)}},[t]),re.useEffect(()=>{if(!t)return;o(!0);const D=Fv(Ki(dt,"songs"),LV("userId","==",t.uid)),w=Bv(D,_=>{let E=_.docs.map(O=>{var v;const L=O.data();return{id:O.id,...L,createdAt:(v=L.createdAt)!=null&&v.toMillis?L.createdAt.toMillis():Date.now()}});if(E.some(O=>O.orderIndex===void 0)){E=E.sort((L,v)=>(L.createdAt||0)-(v.createdAt||0)).map((L,v)=>({...L,orderIndex:v}));const O=dd(dt);E.forEach(L=>{const v=Xr(dt,"songs",L.id);O.update(v,{orderIndex:L.orderIndex})}),O.commit().catch(L=>console.error("Migration failed:",L))}else E.sort((O,L)=>(O.orderIndex||0)-(L.orderIndex||0));n(E),o(!1)},_=>{console.error("[Firestore] Sync error:",_),o(!1)});return()=>w()},[t]),re.useEffect(()=>{if(!t||!r){u([]);return}const D=Ki(dt,"songs",r,"pages"),w=Fv(D,FV("pageIndex","asc")),_=Bv(w,E=>{const V=E.docs.map(O=>O.data().url);u(V)},E=>{console.error("[Firestore] Pages sync error:",E)});return()=>_()},[t,r]);const c=re.useCallback(async D=>{const w=e.length>0?Math.max(...e.map(O=>O.orderIndex||0))+1:0,{imageUrls:_,...E}=D,V={title:"名称未設定の曲",artist:"",bpm:120,scrollSpeed:20,orderIndex:w,...E};if(t)try{const L={id:`temp-${Date.now()}`,...V,createdAt:Date.now(),isOptimistic:!0,imageUrls:_};n(g=>[...g,L]),console.log("[Firestore] Saving song metadata...");const v=await hd(Ki(dt,"songs"),{...V,userId:t.uid,createdAt:zl()});if(_&&_.length>0){console.log(`[Firestore] Saving ${_.length} pages...`);for(let g=0;g<_.length;g++){const I=_[g];if(I.length>1e6)throw new Error(`画像 ${g+1} 枚目が大きすぎます (1MB超)`);const A=Xr(Ki(dt,"songs",v.id,"pages"));await hd(Ki(dt,"songs",v.id,"pages"),{url:I,pageIndex:g,createdAt:zl()})}}return console.log("[Firestore] Add successful"),{id:v.id,...V,imageUrls:_}}catch(O){throw console.error("[Firestore] Add error detailed:",O),O}else{const O={id:crypto.randomUUID(),...V,imageUrls:_,createdAt:Date.now()},L=[...e,O].sort((v,g)=>v.orderIndex-g.orderIndex);return n(L),localStorage.setItem(Wi,JSON.stringify(L)),O}},[t,e]),f=re.useCallback(async(D,w)=>{const{imageUrls:_,...E}=w;if(t)try{console.log("[Firestore] Updating song metadata:",D);const V=Xr(dt,"songs",D);await zV(V,{...E,imageUrls:[],imageUrl:"",updatedAt:zl()}),console.log("[Firestore] Syncing pages...");const O=Ki(dt,"songs",D,"pages"),L=await BV(O),v=dd(dt);if(L.forEach(g=>v.delete(g.ref)),await v.commit(),_&&_.length>0)for(let g=0;g<_.length;g++){const I=_[g];if(I.length>1048487)throw new Error(`画像 ${g+1} 枚目が大きすぎます`);await hd(O,{url:I,pageIndex:g,createdAt:zl()})}console.log("[Firestore] Update successful")}catch(V){throw console.error("[Firestore] Update error detailed:",V),V}else{const V=e.map(O=>O.id===D?{...O,...E,imageUrls:_}:O);n(V),localStorage.setItem(Wi,JSON.stringify(V))}},[t,e]),p=re.useCallback(async D=>{if(t)try{await $V(Xr(dt,"songs",D))}catch(w){throw console.error("[Firestore] Delete error:",w),w}else{const w=e.filter(_=>_.id!==D);n(w),localStorage.setItem(Wi,JSON.stringify(w))}r===D&&i(null)},[t,e,r]),m=re.useCallback(async(D,w)=>{const _=e.findIndex(g=>g.id===D);if(_<0)return;const E=_+w;if(E<0||E>=e.length)return;const V=[...e],O={...V[_]},L={...V[E]},v=O.orderIndex;if(O.orderIndex=L.orderIndex,L.orderIndex=v,t)try{const g=dd(dt);g.update(Xr(dt,"songs",O.id),{orderIndex:O.orderIndex}),g.update(Xr(dt,"songs",L.id),{orderIndex:L.orderIndex}),await g.commit()}catch(g){console.error("[Firestore] Move error:",g)}else V[_]=O,V[E]=L,V.sort((g,I)=>g.orderIndex-I.orderIndex),n(V),localStorage.setItem(Wi,JSON.stringify(V))},[t,e]),T=e.find(D=>D.id===r)||null,P=t?l.length>0?l:(T==null?void 0:T.imageUrls)||[]:(T==null?void 0:T.imageUrls)||[],C=T?{...T,imageUrls:P}:null;return{songs:e,currentSong:C,currentSongId:r,setCurrentSongId:i,addSong:c,updateSong:f,deleteSong:p,moveSong:m,loading:s}}function WV({songs:t,currentSongId:e,onSelect:n,onMove:r}){return F.jsxs("div",{className:"song-list-container",children:[t.length===0?F.jsx("div",{className:"empty-msg",children:"楽曲が登録されていません"}):F.jsx("ul",{className:"list-items",children:t.map((i,s)=>F.jsxs("li",{className:`song-item ${i.id===e?"active":""}`,onClick:()=>n(i.id),children:[F.jsxs("div",{className:"song-main",children:[F.jsx("div",{className:"song-title",children:i.title}),F.jsxs("div",{className:"song-meta",children:[i.artist||"Unknown"," / BPM: ",i.bpm]})]}),F.jsxs("div",{className:"song-reorder",onClick:o=>o.stopPropagation(),children:[F.jsx("button",{className:"reorder-btn",onClick:()=>r(i.id,-1),disabled:s===0,title:"上に移動",children:"▲"}),F.jsx("button",{className:"reorder-btn",onClick:()=>r(i.id,1),disabled:s===t.length-1,title:"下に移動",children:"▼"})]})]},i.id))}),F.jsx("style",{jsx:!0,children:`
      ...
      `})]})}function JV({song:t,isPlaying:e,scrollSpeed:n,scrollPos:r,onScrollUpdate:i,onTogglePlay:s}){const o=re.useRef(null),l=re.useRef(0),{imageUrls:u,imageUrl:c}=t,f=u||(c?[c]:[]);re.useEffect(()=>{let P,C=performance.now();const D=w=>{if(e){const _=(w-C)/1e3,E=n*_;i(V=>V+E)}C=w,P=requestAnimationFrame(D)};return P=requestAnimationFrame(D),()=>cancelAnimationFrame(P)},[e,n,i]),re.useEffect(()=>{o.current&&Math.abs(o.current.scrollTop-r)>1&&(o.current.scrollTop=r)},[r]);const p=P=>{e||i(P.target.scrollTop)},m=()=>{l.current=Date.now()},T=P=>{Date.now()-l.current<250&&s()};return F.jsxs("div",{className:"chord-viewer",ref:o,onScroll:p,onMouseDown:m,onMouseUp:T,onTouchStart:m,onTouchEnd:T,children:[F.jsx("div",{className:"chord-content-wrapper",children:f.length>0?F.jsx("div",{className:"images-stack",children:f.map((P,C)=>F.jsx("img",{src:P,alt:`Sheet Music Page ${C+1}`,className:"sheet-image"},C))}):F.jsx("div",{className:"no-image-msg",children:"楽譜画像がありません"})}),F.jsx("style",{jsx:!0,children:`
        .chord-viewer {
          width: 100%;
          height: 100%;
          overflow-y: auto;
      ...
      `})]})}const eb=400;function tb(){const[t,e]=re.useState(null),[n,r]=re.useState(window.innerWidth<768),[i,s]=re.useState(!0),o=re.useRef(null);re.useEffect(()=>{const fe=$C(Bf,ge=>{e(ge)});return()=>fe()},[]);const{songs:l,currentSong:u,currentSongId:c,setCurrentSongId:f,addSong:p,updateSong:m,deleteSong:T,moveSong:P,loading:C}=KV(t),[D,w]=re.useState(!1),[_,E]=re.useState(!1),[V,O]=re.useState(0),[L,v]=re.useState(20),g=re.useCallback(()=>{if(s(!0),o.current&&clearTimeout(o.current),u&&!D){const fe=_?1e3:2e3;o.current=setTimeout(()=>{s(!1)},fe)}},[_,u,D]);re.useEffect(()=>(s(!0),g(),()=>{o.current&&clearTimeout(o.current)}),[_,u,D]);const I=re.useCallback(()=>{E(fe=>!fe)},[]),A=re.useCallback(()=>{E(!1),O(0)},[]);re.useEffect(()=>{const fe=ge=>{ge.code==="Space"&&!D&&(ge.preventDefault(),I()),ge.code==="KeyS"&&!D&&r(At=>!At)};return window.addEventListener("keydown",fe),()=>window.removeEventListener("keydown",fe)},[I,D]);const R=re.useCallback(()=>{if(u!=null&&u.bpm){const fe=u.bpm/60/4*eb;v(Math.round(fe))}},[u]),x=fe=>{f(fe),w(!1),A();const ge=l.find(At=>At.id===fe);ge!=null&&ge.scrollSpeed&&v(ge.scrollSpeed)},S=async fe=>{try{if(c)await m(c,{...fe,scrollSpeed:L});else{const ge=await p({...fe,scrollSpeed:L});ge&&ge.id&&f(ge.id)}w(!1)}catch(ge){let At="保存に失敗しました。";ge.message&&(At+=`
原因: ${ge.message}`),ge.code==="permission-denied"&&(At+=`
設定エラー: データベースの書き込み権限がありません。管理者にお問い合わせください。`),alert(At),console.error(ge)}},Ue=async fe=>{window.confirm("この曲を削除してもよろしいですか？")&&(await T(fe),w(!1))};return F.jsxs("div",{className:`app-container ${n?"sidebar-collapsed":""}`,onClick:g,onTouchStart:g,onMouseMove:g,children:[F.jsxs("nav",{className:"sidebar",children:[F.jsxs("div",{className:"sidebar-header",children:[F.jsx("h1",{children:"Guitar Scroll"}),F.jsx("button",{className:"toggle-btn",onClick:()=>r(!0),children:"◀"})]}),F.jsx(ZV,{user:t}),F.jsx(WV,{songs:l,currentSongId:c,onSelect:x,onMove:P}),F.jsx("div",{className:"sidebar-footer",children:F.jsx("button",{className:"add-button",onClick:()=>{f(null),w(!0)},children:"＋ 新しい曲"})})]}),F.jsxs("main",{className:"main-content",children:[F.jsxs("header",{className:`app-header ${i?"":"header-hidden"}`,children:[F.jsx("div",{className:"song-info",children:u?F.jsxs(F.Fragment,{children:[F.jsx("h2",{children:u.title}),F.jsxs("span",{className:"metadata",children:[u.artist," | BPM: ",u.bpm]})]}):F.jsx("h2",{children:C?"読み込み中...":"曲を選択してください"})}),F.jsx("div",{className:"app-actions",children:u&&F.jsx("button",{className:"edit-toggle",onClick:()=>w(!D),children:D?"完了":"編集"})})]}),F.jsx("section",{className:"viewer-area",children:D?F.jsx(YV,{song:u,onSave:S,onCancel:()=>w(!1),onDelete:Ue}):u?F.jsx(JV,{song:u,isPlaying:_,scrollSpeed:L,scrollPos:V,onScrollUpdate:O,onTogglePlay:I}):F.jsx("div",{className:"placeholder-msg",children:F.jsx("p",{children:"曲を選択するか「＋ 新しい曲」から楽譜画像を追加してください。"})})}),(u||n&&!D)&&F.jsx("footer",{className:`controls-area floating-panel ${i?"":"controls-hidden"}`,children:F.jsxs("div",{className:"floating-inner",children:[F.jsxs("div",{className:"top-row",children:[n&&F.jsx("button",{className:"expand-btn-floating",onClick:()=>r(!1),children:"☰ 曲一覧"}),u&&F.jsx("div",{className:"bpm-sync-panel",children:F.jsx("button",{className:"sync-btn",onClick:R,children:"BPM同期"})})]}),u&&F.jsx(XV,{isPlaying:_,onTogglePlay:I,onReset:A,scrollSpeed:L,onSpeedChange:v})]})})]}),F.jsx("style",{jsx:!0,children:`
        .app-container {
          display: flex;
          height: 100vh;
          height: 100dvh;
